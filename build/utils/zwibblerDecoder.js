...
exports.decodeAdvanced = exports.decode = exports.encode = exports.CreationMode = exports.DecodeError = exports.MessageType = void 0;
var MessageType;
(function (MessageType) {
    MessageType[MessageType["INIT"] = 1] = "INIT";
    MessageType[MessageType["APPEND"] = 2] = "APPEND";
    MessageType[MessageType["SET_KEY"] = 3] = "SET_KEY";
    MessageType[MessageType["BROADCAST"] = 4] = "BROADCAST";
    MessageType[MessageType["ERROR"] = 128] = "ERROR";
    MessageType[MessageType["ACK_NACK"] = 129] = "ACK_NACK";
    MessageType[MessageType["KEY_INFORMATION"] = 130] = "KEY_INFORMATION";
    MessageType[MessageType["SET_KEY_ACK_NACK"] = 131] = "SET_KEY_ACK_NACK";
    MessageType[MessageType["CONTINUATION"] = 255] = "CONTINUATION";
})(MessageType = exports.MessageType || (exports.MessageType = {}));
var DecodeError;
(function (DecodeError) {
    DecodeError[DecodeError["UNSPECIFIED"] = 0] = "UNSPECIFIED";
    DecodeError[DecodeError["DOES_NOT_EXIST"] = 1] = "DOES_NOT_EXIST";
    DecodeError[DecodeError["ALREADY_EXISTS"] = 2] = "ALREADY_EXISTS";
    DecodeError[DecodeError["INVALID_OFFSET"] = 3] = "INVALID_OFFSET";
    DecodeError[DecodeError["UNIMPLEMENTED_ERROR"] = 4] = "UNIMPLEMENTED_ERROR";
})(DecodeError = exports.DecodeError || (exports.DecodeError = {}));
var CreationMode;
(function (CreationMode) {
    CreationMode[CreationMode["POSSIBLY_CREATE"] = 0] = "POSSIBLY_CREATE";
    CreationMode[CreationMode["NEVER_CREATE"] = 1] = "NEVER_CREATE";
    CreationMode[CreationMode["ALWAYS_CREATE"] = 2] = "ALWAYS_CREATE";
})(CreationMode = exports.CreationMode || (exports.CreationMode = {}));
// Message types
// const INIT = 0x01;
// const ERROR = 0x80;
// const ACK_NACK = 0x81;
...
//   ALWAYS_CREATE = 2
// }
function field(length, type, name, decoder) {
...
function readString(m, at, length = m.length - at) {
...
function decodeAdvanced(m, client, fromServer) {
    const dec = {
        type: 'unknown',
        client: client,
...
exports.decodeAdvanced = decodeAdvanced;
