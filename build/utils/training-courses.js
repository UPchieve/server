...
exports.getProgress = exports.getCourse = exports.courses = exports.legacyCoursesv2 = exports.legacyCourses = void 0;
...
(function (MaterialType) {
    ...
    MaterialType["RESOURCES"] = "resources";
        ...
        modules: [
            {
                ...
                materials: [
                    ...
                    },
                    {
                        ...
                        isRequired: false,
                        linkUrl: 'https://join.slack.com/t/upchieveaccommunity/shared_invite/zt-1gihzt03n-Sj58fEdBiZjVwc4DPDdg0g',
                    },
                    {
                        ...
                        type: MaterialType.LINK,
                        isRequired: false,
                        linkUrl: 'https://us02web.zoom.us/meeting/register/uZUsduiqrzgiO4_zJG9YvVJcx8vBxt4snA',
                    },
                    {
            ...
            },
            {
                ...
                materials: [
                    ...
                    },
                    {
                        ...
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/choosing-references.pdf',
                    },
                    {
                        name: 'Additional Resources',
                        materialKey: '1hh701',
            ...
            },
            {
                ...
                materials: [
                    ...
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/student-safety-policy.pdf',
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/personal-questions.pdf',
                    },
                ],
            },
            {
                ...
                materials: [
                    ...
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/academic-integrity-v1.pdf',
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/cheating-examples.pdf',
                    },
                ],
            },
            {
                ...
                materials: [
                    ...
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/dei-policy.pdf',
                    },
                    {
            ...
            },
            {
                ...
                materials: [
                    ...
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/reporting-guidelines.pdf',
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/challenging-scenarios.pdf',
                    },
                ],
            },
        ],
                ...
                materials: [
                    {
                        ...
                        isRequired: true,
                        resourceId: '459021055',
                        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/introduction-to-upchieve-deck.pdf',
                    },
                    {
                    ...
                    {
                        name: 'Join the UPchieve Slack Community',
                        description: 'Join our Coach Slack Community to connect with other coaches, learn about best-practices, and meet our amazing team of equity-oriented volunteers!',
                        materialKey: '1s3654',
                        type: MaterialType.LINK,
                        isRequired: false,
                        linkUrl: 'https://join.slack.com/t/upchieveaccommunity/shared_invite/zt-1gihzt03n-Sj58fEdBiZjVwc4DPDdg0g',
                    },
                    {
                        ...
                        links: [
                            {
                                displayName: 'Get Ready to Make a Difference: What Our Students Say',
                ...
                materials: [
                    {
                        ...
                        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/using-our-platform-deck.pdf',
                    },
                    {
                        ...
                        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/implementing-effective-coaching-strategies-deck.pdf',
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/upchieve-coaching-strategies.pdf',
                    },
                    {
                        ...
                        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/responding-to-tricky-coaching-situations-deck.pdf',
                    },
                    {
                        ...
                        links: [
                            {
                                displayName: 'FAQ About the Process of Becoming an UPchieve Coach',
                    ...
                    },
                    {
                        ...
                        type: MaterialType.LINK,
                        isRequired: false,
                        description: 'Want to try out our platform as a student? Play around with our whiteboard or doc editor without picking up a request using our demo site!\n\nusername: volunteers@upchieve.org\npassword: volunteeronboarding!',
                ...
                materials: [
                    {
                        ...
                        isRequired: true,
                        resourceId: '459021056',
                        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/dei-deck.pdf',
                    },
                    {
                        name: 'UPchieve DEI Policy',
                        materialKey: 'fj8tzq',
                ...
                materials: [
                    {
                        ...
                        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/community-safety-&-success-deck.pdf',
                    },
                    {
                        name: 'UPchieve Student Safety Policy',
                        materialKey: 'ps87f9',
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/upchieve-student-safety-policy.pdf',
                    },
                    {
                        name: 'Academic Integrity',
                        materialKey: '3gh7dh',
                        ...
                        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/academic-integrity-deck.pdf',
                    },
                    {
                        name: 'UPchieve Academic Integrity Policy',
                        materialKey: 'jgu55k',
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/upchieve-academic-integrity-policy.pdf',
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/review-coach-actions-that-promote-success.pdf',
                    },
                    {
            ...
            },
            {
                ...
                materials: [
                    ...
                    },
                    {
                        ...
                        type: MaterialType.DOCUMENT,
                        isRequired: true,
                        linkUrl: 'https://cdn.upchieve.org/training-courses/upchieve101/volunteer-dei-policy-v2.pdf',
                    },
                ],
            },
        ],
...
function addUsingOurPlatformTo101(course) {
    const updatedCourse = (0, lodash_1.cloneDeep)(course);
    const material = {
        name: 'Using Our Platform',
        materialKey: '212h45',
        type: MaterialType.VIDEO,
        isRequired: true,
        resourceId: '797113791',
        videoPDF: 'https://cdn.upchieve.org/training-courses/upchieve101/video-decks/using-our-platform-deck-v2.pdf',
    };
    const coachingModule = updatedCourse.modules.find(module => module.name === 'Coaching on UPchieve');
    if (coachingModule)
        coachingModule.materials.unshift(material);
    return updatedCourse;
}
const getCourse = async (courseKey, userId) => {
    const course = (0, lodash_1.find)(exports.courses, { courseKey });
    if (!course)
        throw new Error(`Training course does not exist for key ${courseKey}`);
    const isShowPlatformActive = await (0, FeatureFlagService_1.getUsingOurPlatformFlag)(userId);
    return isShowPlatformActive ? addUsingOurPlatformTo101(course) : course;
};
exports.getCourse = getCourse;
const getRequiredMaterials = async (courseKey, userId) => {
    const course = await (0, exports.getCourse)(courseKey, userId);
    return (0, lodash_1.chain)(course.modules)
        .map('materials')
        .flatten()
        .filter('isRequired')
        .map('materialKey')
...
const getProgress = async (courseKey, userCompleted, userId) => {
