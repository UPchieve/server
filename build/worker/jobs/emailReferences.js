...
exports.default = async () => {
    const volunteers = await (0, Volunteer_1.getVolunteersForEmailReference)();
    const unsent = (0, lodash_1.flatten)(volunteers.map(vol => {
    ...
    (0, logger_1.log)(`Sent ${_1.Jobs.EmailReferences} to ${totalEmailed} references`);
    if (errors.length) {
