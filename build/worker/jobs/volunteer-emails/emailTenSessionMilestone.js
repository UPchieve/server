...
exports.default = async (job) => {
    ...
    if (!volunteer)
        return;
    const sessions = await (0, Session_1.getSessionsVolunteerRating)(volunteerId);
    if (sessions.length === 10) {
        try {
            await MailService.sendVolunteerTenSessionMilestone(volunteer.email, volunteer.firstName);
