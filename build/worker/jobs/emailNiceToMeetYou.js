...
exports.default = async () => {
    ...
    const volunteers = await (0, queries_1.getVolunteersForNiceToMeetYou)(new Date(oneDayAgo), new Date(todaysDate));
    let totalEmailed = 0;
    const errors = [];
    ...
    (0, logger_1.log)(`Sent ${_1.Jobs.EmailNiceToMeetYou} to ${totalEmailed} volunteers`);
    if (errors.length) {
        throw new Error(`Failed to send ${_1.Jobs.EmailNiceToMeetYou} to: ${errors}`);
    }
};
