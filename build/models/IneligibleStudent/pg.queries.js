...
exports.deleteIneligibleStudent = exports.getIneligibleStudentsPaginated = exports.insertIneligibleStudent = exports.getIneligibleStudentByEmail = void 0;
 ...
 * ```
 */
exports.getIneligibleStudentsPaginated = new query_1.PreparedQuery(getIneligibleStudentsPaginatedIR);
const deleteIneligibleStudentIR = { "name": "deleteIneligibleStudent", "params": [{ "name": "email", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2015, "b": 2020, "line": 72, "col": 15 }] } }], "usedParamSet": { "email": true }, "statement": { "body": "DELETE FROM ineligible_students\nWHERE email = :email!", "loc": { "a": 1968, "b": 2020, "line": 71, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 ...
 * ```
 */
exports.deleteIneligibleStudent = new query_1.PreparedQuery(deleteIneligibleStudentIR);
