...
exports.getProgressReportSurveyResponse = exports.deleteDuplicateUserSurveys = exports.getVolunteerSessionRating = exports.getStudentSessionRating = exports.getVolunteerPostsessionSurveyResponse = exports.getStudentPostsessionSurveyResponse = exports.getPresessionSurveyResponse = exports.getPostsessionSurveyDefinitionWithoutReplacementColumns = exports.getPostsessionSurveyReplacementColumns = exports.getSimpleSurveyDefinition = exports.getStudentsPresessionGoal = exports.getPresessionSurveyForFeedback = exports.saveUserSurveySubmissions = exports.saveUserSurvey = exports.savePresessionSurvey = void 0;
/** Types generated for queries found in "server/models/Survey/surveys.sql" */
const query_1 = require("@pgtyped/query");
const savePresessionSurveyIR = { "name": "savePresessionSurvey", "params": [{ "name": "id", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 142, "b": 144, "line": 4, "col": 5 }] } }, { "name": "userId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 152, "b": 158, "line": 5, "col": 5 }] } }, { "name": "sessionId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 166, "b": 175, "line": 6, "col": 5 }] } }, { "name": "responseData", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 183, "b": 195, "line": 7, "col": 5 }, { "a": 287, "b": 299, "line": 12, "col": 25 }] } }], "usedParamSet": { "id": true, "userId": true, "sessionId": true, "responseData": true }, "statement": { "body": "INSERT INTO pre_session_surveys (id, user_id, session_id, response_data, created_at, updated_at)\nSELECT\n    :id!,\n    :userId!,\n    :sessionId!,\n    :responseData!,\n    NOW(),\n    NOW()\nON CONFLICT (session_id)\n    DO UPDATE SET\n        response_data = :responseData!,\n        updated_at = NOW()::date\n    RETURNING\n        id,\n        user_id,\n        session_id,\n        response_data,\n        created_at,\n        updated_at", "loc": { "a": 33, "b": 458, "line": 2, "col": 0 } } };
/**
 ...
 * ```
 */
exports.saveUserSurveySubmissions = new query_1.PreparedQuery(saveUserSurveySubmissionsIR);
const getPresessionSurveyForFeedbackIR = { "name": "getPresessionSurveyForFeedback", "params": [{ "name": "userId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 1559, "b": 1565, "line": 75, "col": 15 }] } }, { "name": "sessionId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 1589, "b": 1598, "line": 76, "col": 22 }] } }], "usedParamSet": { "userId": true, "sessionId": true }, "statement": { "body": "SELECT\n    id,\n    user_id,\n    session_id,\n    response_data,\n    created_at,\n    updated_at\nFROM\n    pre_session_surveys\nWHERE\n    user_id = :userId!\n    AND session_id = :sessionId!", "loc": { "a": 1415, "b": 1598, "line": 65, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getPostsessionSurveyReplacementColumns = new query_1.PreparedQuery(getPostsessionSurveyReplacementColumnsIR);
 ...
 * ```
 */
exports.getVolunteerPostsessionSurveyResponse = new query_1.PreparedQuery(getVolunteerPostsessionSurveyResponseIR);
const getStudentSessionRatingIR = { "name": "getStudentSessionRating", "params": [{ "name": "sessionId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 16101, "b": 16110, "line": 427, "col": 32 }] } }], "usedParamSet": { "sessionId": true }, "statement": { "body": "SELECT\n    score\nFROM\n    upchieve.users_surveys\n    JOIN upchieve.users_surveys_submissions uss ON users_surveys.id = uss.user_survey_id\n    JOIN upchieve.survey_questions sq ON uss.survey_question_id = sq.id\n    JOIN upchieve.survey_response_choices src ON uss.survey_response_choice_id = src.id\nWHERE\n    users_surveys.session_id = :sessionId!\n    AND sq.question_text = 'Your goal for this session was to %s. Did UPchieve help you achieve your goal?'", "loc": { "a": 15765, "b": 16218, "line": 419, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getStudentSessionRating = new query_1.PreparedQuery(getStudentSessionRatingIR);
const getVolunteerSessionRatingIR = { "name": "getVolunteerSessionRating", "params": [{ "name": "sessionId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 16597, "b": 16606, "line": 440, "col": 32 }] } }], "usedParamSet": { "sessionId": true }, "statement": { "body": "SELECT\n    score\nFROM\n    upchieve.users_surveys\n    JOIN upchieve.users_surveys_submissions uss ON users_surveys.id = uss.user_survey_id\n    JOIN upchieve.survey_questions sq ON uss.survey_question_id = sq.id\n    JOIN upchieve.survey_response_choices src ON uss.survey_response_choice_id = src.id\nWHERE\n    users_surveys.session_id = :sessionId!\n    AND sq.question_text = '%s''s goal for this session was to %s. Were you able to help them achieve their goal?'", "loc": { "a": 16261, "b": 16721, "line": 432, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getVolunteerSessionRating = new query_1.PreparedQuery(getVolunteerSessionRatingIR);
const deleteDuplicateUserSurveysIR = { "name": "deleteDuplicateUserSurveys", "params": [], "usedParamSet": {}, "statement": { "body": "DELETE FROM upchieve.users_surveys\nWHERE id IN (\n        SELECT\n            id\n        FROM (\n            SELECT\n                id,\n                ROW_NUMBER() OVER (PARTITION BY user_id, session_id, survey_id, survey_type_id ORDER BY created_at DESC) AS row_num,\n                created_at\n            FROM\n                users_surveys) t\n        WHERE\n            t.row_num > 1)", "loc": { "a": 16765, "b": 17147, "line": 445, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 ...
 * ```
 */
exports.getProgressReportSurveyResponse = new query_1.PreparedQuery(getProgressReportSurveyResponseIR);
