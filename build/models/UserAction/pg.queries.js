 ...
 * ```
 */
exports.getQuizzesPassedForDateRangeForTelecomReportByVolunteerId = new query_1.PreparedQuery(getQuizzesPassedForDateRangeForTelecomReportByVolunteerIdIR);
const getSessionRequestedUserAgentFromSessionIdIR = { "name": "getSessionRequestedUserAgentFromSessionId", "params": [{ "name": "sessionId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 827, "b": 836, "line": 40, "col": 22 }] } }], "usedParamSet": { "sessionId": true }, "statement": { "body": "SELECT\n    id,\n    device,\n    browser,\n    browser_version,\n    operating_system,\n    operating_system_version\nFROM\n    user_actions\nWHERE\n    action_type = 'SESSION'\n    AND action = 'REQUESTED SESSION'\n    AND session_id = :sessionId!", "loc": { "a": 600, "b": 836, "line": 28, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getSessionRequestedUserAgentFromSessionId = new query_1.PreparedQuery(getSessionRequestedUserAgentFromSessionIdIR);
const upsertIpAddressIR = { "name": "upsertIpAddress", "params": [{ "name": "ip", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 954, "b": 956, "line": 46, "col": 17 }, { "a": 1162, "b": 1164, "line": 61, "col": 14 }] } }], "usedParamSet": { "ip": true }, "statement": { "body": "WITH ins AS (\nINSERT INTO ip_addresses (ip, created_at, updated_at)\n        VALUES (:ip!, NOW(), NOW())\n    ON CONFLICT\n        DO NOTHING\n    RETURNING\n        id)\n    SELECT\n        *\n    FROM\n        ins\n    UNION\n    SELECT\n        id\n    FROM\n        ip_addresses\n    WHERE\n        ip = :ip!", "loc": { "a": 869, "b": 1164, "line": 44, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * WITH ins AS (
 ...
 * ```
 */
exports.upsertIpAddress = new query_1.PreparedQuery(upsertIpAddressIR);
const userHasTakenQuizIR = { "name": "userHasTakenQuiz", "params": [{ "name": "userId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 1442, "b": 1448, "line": 75, "col": 27 }] } }], "usedParamSet": { "userId": true }, "statement": { "body": "SELECT\n    EXISTS (\n        SELECT\n            1\n        FROM\n            user_actions\n        WHERE\n            action_type = 'QUIZ'\n            AND (action = 'PASSED QUIZ'\n                OR action = 'FAILED QUIZ')\n            AND user_id = :userId!)", "loc": { "a": 1198, "b": 1449, "line": 65, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.createAccountAction = new query_1.PreparedQuery(createAccountActionIR);
const createAdminActionIR = { "name": "createAdminAction", "params": [{ "name": "userId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2615, "b": 2621, "line": 101, "col": 13 }] } }, { "name": "actionType", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2625, "b": 2635, "line": 101, "col": 23 }] } }, { "name": "action", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2639, "b": 2645, "line": 101, "col": 37 }] } }], "usedParamSet": { "userId": true, "actionType": true, "action": true }, "statement": { "body": "INSERT INTO user_actions (user_id, action_type, action, created_at, updated_at)\n    VALUES (:userId!, :actionType!, :action!, NOW(), NOW())\nRETURNING\n    id AS ok", "loc": { "a": 2522, "b": 2683, "line": 100, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 ...
 * ```
 */
exports.createAdminAction = new query_1.PreparedQuery(createAdminActionIR);
const deleteSelfFavoritedVolunteersActionsIR = { "name": "deleteSelfFavoritedVolunteersActions", "params": [], "usedParamSet": {}, "statement": { "body": "DELETE FROM user_actions\nWHERE user_id = volunteer_id\n    AND action = 'VOLUNTEER FAVORITED'", "loc": { "a": 2737, "b": 2828, "line": 107, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 ...
 * ```
 */
exports.deleteSelfFavoritedVolunteersActions = new query_1.PreparedQuery(deleteSelfFavoritedVolunteersActionsIR);
