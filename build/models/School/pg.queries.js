 ...
 * ```
 */
exports.getSchoolById = new query_1.PreparedQuery(getSchoolByIdIR);
const getSchoolByNcesIdIR = { "name": "getSchoolByNcesId", "params": [{ "name": "ncessch", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 828, "b": 835, "line": 32, "col": 36 }] } }], "usedParamSet": { "ncessch": true }, "statement": { "body": "SELECT\n    school_id AS id\nFROM\n    school_nces_metadata\nWHERE\n    school_nces_metadata.ncessch = :ncessch!", "loc": { "a": 729, "b": 835, "line": 27, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.getSchools = new query_1.PreparedQuery(getSchoolsIR);
const schoolSearchIR = { "name": "schoolSearch", "params": [{ "name": "query", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2118, "b": 2123, "line": 74, "col": 31 }] } }], "usedParamSet": { "query": true }, "statement": { "body": "SELECT\n    schools.id,\n    COALESCE(schools.name, meta.sch_name) AS name,\n    COALESCE(cities.us_state_code, meta.st) AS state,\n    COALESCE(cities.name, meta.lcity) AS city,\n    meta.lea_name AS district\nFROM\n    schools\n    LEFT JOIN school_nces_metadata meta ON schools.id = meta.school_id\n    LEFT JOIN cities ON schools.city_id = cities.id\nWHERE\n    schools.name ILIKE '%' || :query! || '%'\nLIMIT 100", "loc": { "a": 1736, "b": 2140, "line": 63, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * SELECT
 ...
 * ```
 */
exports.schoolSearch = new query_1.PreparedQuery(schoolSearchIR);
const updateApprovalIR = { "name": "updateApproval", "params": [{ "name": "isApproved", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2211, "b": 2221, "line": 82, "col": 16 }] } }, { "name": "schoolId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2263, "b": 2271, "line": 85, "col": 10 }] } }], "usedParamSet": { "isApproved": true, "schoolId": true }, "statement": { "body": "UPDATE\n    schools\nSET\n    approved = :isApproved!,\n    updated_at = NOW()\nWHERE\n    id = :schoolId!", "loc": { "a": 2172, "b": 2271, "line": 79, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * UPDATE
 ...
 * ```
 */
exports.updateApproval = new query_1.PreparedQuery(updateApprovalIR);
const updateIsPartnerIR = { "name": "updateIsPartner", "params": [{ "name": "isPartner", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2342, "b": 2351, "line": 92, "col": 15 }] } }, { "name": "schoolId", "required": true, "transform": { "type": "scalar" }, "codeRefs": { "used": [{ "a": 2393, "b": 2401, "line": 95, "col": 10 }] } }], "usedParamSet": { "isPartner": true, "schoolId": true }, "statement": { "body": "UPDATE\n    schools\nSET\n    partner = :isPartner!,\n    updated_at = NOW()\nWHERE\n    id = :schoolId!", "loc": { "a": 2304, "b": 2401, "line": 89, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * UPDATE
 ...
 * ```
 */
exports.adminUpdateSchoolMetaData = new query_1.PreparedQuery(adminUpdateSchoolMetaDataIR);
const titlecaseSchoolNamesIR = { "name": "titlecaseSchoolNames", "params": [], "usedParamSet": {}, "statement": { "body": "UPDATE\n    schools\nSET\n    name = INITCAP(name)\nWHERE\n    name ~ '^[A-Z\\s\\d]*$'", "loc": { "a": 2941, "b": 3019, "line": 122, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * UPDATE
 ...
 * ```
 */
exports.titlecaseSchoolNames = new query_1.PreparedQuery(titlecaseSchoolNamesIR);
const titlecaseMetadataSchoolNamesIR = { "name": "titlecaseMetadataSchoolNames", "params": [], "usedParamSet": {}, "statement": { "body": "UPDATE\n    school_nces_metadata\nSET\n    sch_name = INITCAP(sch_name)\nWHERE\n    sch_name ~ '^[A-Z\\s\\d]*$'", "loc": { "a": 3065, "b": 3168, "line": 131, "col": 0 } } };
/**
 * Query generated from SQL:
 * ```
 * UPDATE
 ...
 * ```
 */
exports.getPartnerSchools = new query_1.PreparedQuery(getPartnerSchoolsIR);
