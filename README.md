...
Our unit tests do not incorporate visual testing for SVG components. The SVG components get successfully rendered on the application itself but not within unit or snapshot test markups. 
