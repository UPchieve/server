...
export const Config = Record({
  ...
  upchieveCdnStorageAppId: String,
  upchieveCdnStorageTenantId: String,
  upchieveCdnStorageSecret: String,
  upchieveCdnStorageSubscriptionId: String,
  upchieveCdnStorageAccountName: String,
  upchieveCdnStorageContainer: String,
  version: String,
