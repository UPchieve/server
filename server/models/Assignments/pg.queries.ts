...
const deleteStudentAssignmentIR: any = {"name":"deleteStudentAssignment","params":[{"name":"assignmentId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3933,"b":3945,"line":150,"col":23}]}}],"usedParamSet":{"assignmentId":true},"statement":{"body":"DELETE FROM students_assignments\nWHERE assignment_id = :assignmentId!","loc":{"a":3877,"b":3945,"line":149,"col":0}}};
...
const deleteAssignmentIR: any = {"name":"deleteAssignment","params":[{"name":"assignmentId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":4015,"b":4027,"line":155,"col":12}]}}],"usedParamSet":{"assignmentId":true},"statement":{"body":"DELETE FROM assignments\nWHERE id = :assignmentId!","loc":{"a":3979,"b":4027,"line":154,"col":0}}};
...
/** 'DeleteSessionStudentAssignment' parameters type */
export interface IDeleteSessionStudentAssignmentParams {
  assignmentId: string;
}

/** 'DeleteSessionStudentAssignment' return type */
export type IDeleteSessionStudentAssignmentResult = void;

/** 'DeleteSessionStudentAssignment' query type */
export interface IDeleteSessionStudentAssignmentQuery {
  params: IDeleteSessionStudentAssignmentParams;
  result: IDeleteSessionStudentAssignmentResult;
}

const deleteSessionStudentAssignmentIR: any = {"name":"deleteSessionStudentAssignment","params":[{"name":"assignmentId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":4140,"b":4152,"line":160,"col":23}]}}],"usedParamSet":{"assignmentId":true},"statement":{"body":"DELETE FROM sessions_students_assignments\nWHERE assignment_id = :assignmentId!","loc":{"a":4075,"b":4152,"line":159,"col":0}}};
 ...
 * ```
 */
export const deleteSessionStudentAssignment = new PreparedQuery<IDeleteSessionStudentAssignmentParams,IDeleteSessionStudentAssignmentResult>(deleteSessionStudentAssignmentIR);
