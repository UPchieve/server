...
import { VolunteerPartnerOrg, VolunteerPartnerOrgForRegistration } from './types'

export async function getVolunteerPartnerOrgForRegistrationByKey(key: string): Promise<VolunteerPartnerOrgForRegistration> {
  try {
