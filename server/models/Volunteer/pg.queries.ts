...
const getUniqueStudentsHelpedForAnalyticsReportSummaryByVolunteerIdIR: any = {"name":"getUniqueStudentsHelpedForAnalyticsReportSummaryByVolunteerId","params":[{"name":"volunteerId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":46282,"b":46293,"line":1567,"col":33},{"a":46562,"b":46572,"line":1577,"col":33},{"a":46910,"b":46920,"line":1588,"col":33},{"a":47431,"b":47442,"line":1601,"col":33}]}},{"name":"allTimeStartDate","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":46331,"b":46347,"line":1568,"col":36},{"a":46958,"b":46974,"line":1589,"col":36},{"a":47480,"b":47496,"line":1602,"col":36}]}},{"name":"allTimeEndDate","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":46385,"b":46399,"line":1569,"col":36},{"a":47012,"b":47026,"line":1590,"col":36},{"a":47534,"b":47548,"line":1603,"col":36}]}},{"name":"rangeStartDate","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":46610,"b":46623,"line":1578,"col":36},{"a":47740,"b":47754,"line":1606,"col":36}]}},{"name":"rangeEndDate","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":46661,"b":46672,"line":1579,"col":36},{"a":47792,"b":47804,"line":1607,"col":36}]}},{"name":"studentPartnerOrgIds","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":47089,"b":47109,"line":1591,"col":61},{"a":47611,"b":47631,"line":1604,"col":61}]}},{"name":"studentSchoolIds","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":47162,"b":47178,"line":1592,"col":50},{"a":47684,"b":47700,"line":1605,"col":50}]}}],"usedParamSet":{"volunteerId":true,"allTimeStartDate":true,"allTimeEndDate":true,"rangeStartDate":true,"rangeEndDate":true,"studentPartnerOrgIds":true,"studentSchoolIds":true},"statement":{"body":"WITH unique_students_helped AS (\n    SELECT DISTINCT\n        sessions.student_id\n    FROM\n        sessions\n    WHERE\n        sessions.volunteer_id = :volunteerId!\n        AND sessions.created_at >= :allTimeStartDate!\n        AND sessions.created_at <= :allTimeEndDate!\n),\nunique_students_helped_within_range AS (\n    SELECT DISTINCT\n        sessions.student_id\n    FROM\n        sessions\n    WHERE\n        sessions.volunteer_id = :volunteerId\n        AND sessions.created_at >= :rangeStartDate\n        AND sessions.created_at <= :rangeEndDate\n),\nunique_partner_students_helped AS (\n    SELECT DISTINCT\n        sessions.student_id\n    FROM\n        sessions\n        JOIN student_profiles ON student_profiles.user_id = sessions.student_id\n    WHERE\n        sessions.volunteer_id = :volunteerId\n        AND sessions.created_at >= :allTimeStartDate!\n        AND sessions.created_at <= :allTimeEndDate!\n        AND (student_profiles.student_partner_org_id = ANY (:studentPartnerOrgIds!)\n            OR student_profiles.school_id = ANY (:studentSchoolIds!))\n),\nunique_partner_students_helped_within_range AS (\n    SELECT DISTINCT\n        sessions.student_id\n    FROM\n        sessions\n        JOIN student_profiles ON student_profiles.user_id = sessions.student_id\n    WHERE\n        sessions.volunteer_id = :volunteerId!\n        AND sessions.created_at >= :allTimeStartDate!\n        AND sessions.created_at <= :allTimeEndDate!\n        AND (student_profiles.student_partner_org_id = ANY (:studentPartnerOrgIds!)\n            OR student_profiles.school_id = ANY (:studentSchoolIds!))\n        AND sessions.created_at >= :rangeStartDate!\n        AND sessions.created_at <= :rangeEndDate!\n)\nSELECT\n    (\n        SELECT\n            COALESCE(ARRAY_AGG(student_id), '{}')\n        FROM\n            unique_students_helped) AS unique_students_helped,\n    (\n        SELECT\n            COALESCE(COUNT(*)::int, 0)\n        FROM\n            unique_students_helped) AS total_unique_students_helped,\n    (\n        SELECT\n            COALESCE(ARRAY_AGG(student_id), '{}')\n        FROM\n            unique_students_helped_within_range) AS unique_students_helped_within_range,\n    (\n        SELECT\n            COALESCE(COUNT(*)::int, 0)\n        FROM\n            unique_students_helped_within_range) AS total_unique_students_helped_within_range,\n    (\n        SELECT\n            COALESCE(ARRAY_AGG(student_id), '{}')\n        FROM\n            unique_partner_students_helped) AS unique_partner_students_helped,\n    (\n        SELECT\n            COALESCE(COUNT(*)::int, 0)\n        FROM\n            unique_partner_students_helped) AS total_unique_partner_students_helped,\n    (\n        SELECT\n            COALESCE(ARRAY_AGG(student_id), '{}')\n        FROM\n            unique_partner_students_helped_within_range) AS unique_partner_students_helped_within_range,\n    (\n        SELECT\n            COALESCE(COUNT(*)::int, 0)\n        FROM\n            unique_partner_students_helped_within_range) AS total_unique_partner_students_helped_within_range","loc":{"a":46132,"b":49136,"line":1561,"col":0}}};
...
const getPartnerOrgsByVolunteerIR: any = {"name":"getPartnerOrgsByVolunteer","params":[{"name":"volunteerId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":57577,"b":57588,"line":1847,"col":21}]}}],"usedParamSet":{"volunteerId":true},"statement":{"body":"SELECT\n    vpo.name,\n    vpo.id\nFROM\n    users_volunteer_partner_orgs_instances uvpoi\n    JOIN volunteer_partner_orgs vpo ON vpo.id = uvpoi.volunteer_partner_org_id\nWHERE\n    uvpoi.user_id = :volunteerId!\n    AND deactivated_on IS NULL","loc":{"a":57385,"b":57619,"line":1840,"col":0}}};
...
const adminDeactivateVolunteerPartnershipInstanceIR: any = {"name":"adminDeactivateVolunteerPartnershipInstance","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":57782,"b":57788,"line":1857,"col":15}]}},{"name":"vpoId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":57826,"b":57831,"line":1858,"col":36}]}}],"usedParamSet":{"userId":true,"vpoId":true},"statement":{"body":"UPDATE\n    users_volunteer_partner_orgs_instances\nSET\n    deactivated_on = NOW()\nWHERE\n    user_id = :userId!\n    AND volunteer_partner_org_id = :vpoId!\nRETURNING\n    user_id AS ok","loc":{"a":57680,"b":57859,"line":1852,"col":0}}};
...
const adminInsertVolunteerPartnershipInstanceIR: any = {"name":"adminInsertVolunteerPartnershipInstance","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":58040,"b":58046,"line":1865,"col":13}]}},{"name":"partnerOrgId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":58050,"b":58062,"line":1865,"col":23}]}}],"usedParamSet":{"userId":true,"partnerOrgId":true},"statement":{"body":"INSERT INTO users_volunteer_partner_orgs_instances (user_id, volunteer_partner_org_id, created_at, updated_at)\n    VALUES (:userId!, :partnerOrgId!, NOW(), NOW())\nRETURNING\n    user_id AS ok","loc":{"a":57916,"b":58105,"line":1864,"col":0}}};
...
const getPartnerOrgByKeyIR: any = {"name":"getPartnerOrgByKey","params":[{"name":"partnerOrgKey","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":58360,"b":58372,"line":1878,"col":34}]}}],"usedParamSet":{"partnerOrgKey":true},"statement":{"body":"SELECT\n    volunteer_partner_orgs.id AS partner_id,\n    volunteer_partner_orgs.key AS partner_key,\n    volunteer_partner_orgs.name AS partner_name\nFROM\n    volunteer_partner_orgs\nWHERE\n    volunteer_partner_orgs.key = :partnerOrgKey\nLIMIT 1","loc":{"a":58141,"b":58380,"line":1871,"col":0}}};
