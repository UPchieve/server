...
export interface IGetUniqueStudentsHelpedForAnalyticsReportSummaryParams {
  ...
  start: Date;
  studentPartnerOrgIds: stringArray | null | void;
  studentSchoolIds: stringArray | null | void;
  volunteerPartnerOrg: string;
}
