...
/** 'GetVolunteerProfileByUserId' parameters type */
export interface IGetVolunteerProfileByUserIdParams {
  userId: string;
}

/** 'GetVolunteerProfileByUserId' return type */
export interface IGetVolunteerProfileByUserIdResult {
  approved: boolean;
  city: string | null;
  college: string | null;
  company: string | null;
...
/** 'GetVolunteerProfileByUserId' query type */
export interface IGetVolunteerProfileByUserIdQuery {
  params: IGetVolunteerProfileByUserIdParams;
  result: IGetVolunteerProfileByUserIdResult;
}

const getVolunteerProfileByUserIdIR: any = {"usedParamSet":{"userId":true},"params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"locs":[{"a":61,"b":68}]}],"statement":"SELECT\n    *\nFROM\n    volunteer_profiles\nWHERE\n    user_id = :userId!"};
 ...
 * ```
 */
export const getVolunteerProfileByUserId = new PreparedQuery<IGetVolunteerProfileByUserIdParams,IGetVolunteerProfileByUserIdResult>(getVolunteerProfileByUserIdIR);
