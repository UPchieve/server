...
/** Query 'CreateUsmByUserId' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateUsmByUserIdResult = never;

/** Query 'CreateUsmByUserId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateUsmByUserIdParams = never;
...
/** Query 'GetUsmByUserId' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetUsmByUserIdResult = never;

/** Query 'GetUsmByUserId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetUsmByUserIdParams = never;
...
/** Query 'ExecuteUsmUpdatesByUserId' is invalid, so its result is assigned type 'never'.
 *  */
export type IExecuteUsmUpdatesByUserIdResult = never;

/** Query 'ExecuteUsmUpdatesByUserId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IExecuteUsmUpdatesByUserIdParams = never;
