...
/** Query 'GetIneligibleStudentByEmail' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetIneligibleStudentByEmailResult = never;

/** Query 'GetIneligibleStudentByEmail' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetIneligibleStudentByEmailParams = never;
...
/** Query 'InsertIneligibleStudent' is invalid, so its result is assigned type 'never'.
 *  */
export type IInsertIneligibleStudentResult = never;

/** Query 'InsertIneligibleStudent' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IInsertIneligibleStudentParams = never;
...
/** Query 'GetIneligibleStudentsPaginated' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetIneligibleStudentsPaginatedResult = never;

/** Query 'GetIneligibleStudentsPaginated' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetIneligibleStudentsPaginatedParams = never;
...
/** Query 'DeleteIneligibleStudent' is invalid, so its result is assigned type 'never'.
 *  */
export type IDeleteIneligibleStudentResult = never;

/** Query 'DeleteIneligibleStudent' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IDeleteIneligibleStudentParams = never;
