...
/** Query 'SaveUserSurvey' is invalid, so its result is assigned type 'never'.
 *  */
export type ISaveUserSurveyResult = never;

/** Query 'SaveUserSurvey' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ISaveUserSurveyParams = never;
...
/** Query 'SaveUserSurveySubmissions' is invalid, so its result is assigned type 'never'.
 *  */
export type ISaveUserSurveySubmissionsResult = never;

/** Query 'SaveUserSurveySubmissions' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ISaveUserSurveySubmissionsParams = never;
...
/** Query 'GetStudentsPresessionGoal' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentsPresessionGoalResult = never;

/** Query 'GetStudentsPresessionGoal' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentsPresessionGoalParams = never;
...
/** Query 'GetPostsessionSurveyDefinitionForSession' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetPostsessionSurveyDefinitionForSessionResult = never;

/** Query 'GetPostsessionSurveyDefinitionForSession' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetPostsessionSurveyDefinitionForSessionParams = never;
...
/** Query 'GetPresessionSurveyResponse' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetPresessionSurveyResponseResult = never;

/** Query 'GetPresessionSurveyResponse' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetPresessionSurveyResponseParams = never;
...
/** Query 'GetStudentPostsessionSurveyResponse' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentPostsessionSurveyResponseResult = never;

/** Query 'GetStudentPostsessionSurveyResponse' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentPostsessionSurveyResponseParams = never;
...
/** Query 'GetVolunteerPostsessionSurveyResponse' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetVolunteerPostsessionSurveyResponseResult = never;

/** Query 'GetVolunteerPostsessionSurveyResponse' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetVolunteerPostsessionSurveyResponseParams = never;
...
/** Query 'GetStudentSessionRating' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentSessionRatingResult = never;

/** Query 'GetStudentSessionRating' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentSessionRatingParams = never;
...
/** Query 'GetVolunteerSessionRating' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetVolunteerSessionRatingResult = never;

/** Query 'GetVolunteerSessionRating' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetVolunteerSessionRatingParams = never;
...
/** Query 'DeleteDuplicateUserSurveys' is invalid, so its result is assigned type 'never'.
 *  */
export type IDeleteDuplicateUserSurveysResult = never;

/** Query 'DeleteDuplicateUserSurveys' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IDeleteDuplicateUserSurveysParams = never;
...
/** Query 'GetProgressReportSurveyResponse' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetProgressReportSurveyResponseResult = never;

/** Query 'GetProgressReportSurveyResponse' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetProgressReportSurveyResponseParams = never;
...
/** Query 'GetStudentPostsessionSurveyGoalQuestionRatings' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentPostsessionSurveyGoalQuestionRatingsResult = never;

/** Query 'GetStudentPostsessionSurveyGoalQuestionRatings' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentPostsessionSurveyGoalQuestionRatingsParams = never;
...
/** Query 'GetVolunteerPostsessionSurveyGoalQuestionRatings' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetVolunteerPostsessionSurveyGoalQuestionRatingsResult = never;

/** Query 'GetVolunteerPostsessionSurveyGoalQuestionRatings' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetVolunteerPostsessionSurveyGoalQuestionRatingsParams = never;
