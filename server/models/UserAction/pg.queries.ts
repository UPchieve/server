...
/** Query 'GetQuizzesPassedForDateRangeByVolunteerId' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetQuizzesPassedForDateRangeByVolunteerIdResult = never;

/** Query 'GetQuizzesPassedForDateRangeByVolunteerId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetQuizzesPassedForDateRangeByVolunteerIdParams = never;
...
/** Query 'GetQuizzesPassedForDateRangeForTelecomReportByVolunteerId' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetQuizzesPassedForDateRangeForTelecomReportByVolunteerIdResult = never;

/** Query 'GetQuizzesPassedForDateRangeForTelecomReportByVolunteerId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetQuizzesPassedForDateRangeForTelecomReportByVolunteerIdParams = never;
...
/** Query 'GetIpAddressByIp' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetIpAddressByIpResult = never;

/** Query 'GetIpAddressByIp' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetIpAddressByIpParams = never;
...
/** Query 'UpsertIpAddress' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpsertIpAddressResult = never;

/** Query 'UpsertIpAddress' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpsertIpAddressParams = never;
...
/** Query 'UserHasTakenQuiz' is invalid, so its result is assigned type 'never'.
 *  */
export type IUserHasTakenQuizResult = never;

/** Query 'UserHasTakenQuiz' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUserHasTakenQuizParams = never;
...
/** Query 'CreateQuizAction' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateQuizActionResult = never;

/** Query 'CreateQuizAction' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateQuizActionParams = never;
...
/** Query 'CreateAccountAction' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateAccountActionResult = never;

/** Query 'CreateAccountAction' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateAccountActionParams = never;
...
/** Query 'CreateAdminAction' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateAdminActionResult = never;

/** Query 'CreateAdminAction' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateAdminActionParams = never;
...
/** Query 'DeleteSelfFavoritedVolunteersActions' is invalid, so its result is assigned type 'never'.
 *  */
export type IDeleteSelfFavoritedVolunteersActionsResult = never;

/** Query 'DeleteSelfFavoritedVolunteersActions' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IDeleteSelfFavoritedVolunteersActionsParams = never;
