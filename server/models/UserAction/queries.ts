...
export async function getActionsWithPipeline(pipeline: any): Promise<UserAction[]> {
...
export async function userHasTakenQuiz(userId: Types.ObjectId): Promise<boolean> {
