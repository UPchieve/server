...
/** Query 'GetGatesStudentById' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetGatesStudentByIdResult = never;

/** Query 'GetGatesStudentById' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetGatesStudentByIdParams = never;
...
/** Query 'GetStudentContactInfoById' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentContactInfoByIdResult = never;

/** Query 'GetStudentContactInfoById' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentContactInfoByIdParams = never;
...
/** Query 'GetStudentByEmail' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentByEmailResult = never;

/** Query 'GetStudentByEmail' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentByEmailParams = never;
...
/** Query 'IsTestUser' is invalid, so its result is assigned type 'never'.
 *  */
export type IIsTestUserResult = never;

/** Query 'IsTestUser' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IIsTestUserParams = never;
...
/** Query 'GetTotalFavoriteVolunteers' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetTotalFavoriteVolunteersResult = never;

/** Query 'GetTotalFavoriteVolunteers' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetTotalFavoriteVolunteersParams = never;
...
/** Query 'IsFavoriteVolunteer' is invalid, so its result is assigned type 'never'.
 *  */
export type IIsFavoriteVolunteerResult = never;

/** Query 'IsFavoriteVolunteer' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IIsFavoriteVolunteerParams = never;
...
/** Query 'GetFavoriteVolunteersByStudentId' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetFavoriteVolunteersByStudentIdResult = never;

/** Query 'GetFavoriteVolunteersByStudentId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetFavoriteVolunteersByStudentIdParams = never;
...
/** Query 'GetFavoriteVolunteersPaginated' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetFavoriteVolunteersPaginatedResult = never;

/** Query 'GetFavoriteVolunteersPaginated' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetFavoriteVolunteersPaginatedParams = never;
...
/** Query 'DeleteFavoriteVolunteer' is invalid, so its result is assigned type 'never'.
 *  */
export type IDeleteFavoriteVolunteerResult = never;

/** Query 'DeleteFavoriteVolunteer' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IDeleteFavoriteVolunteerParams = never;
...
/** Query 'AddFavoriteVolunteer' is invalid, so its result is assigned type 'never'.
 *  */
export type IAddFavoriteVolunteerResult = never;

/** Query 'AddFavoriteVolunteer' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAddFavoriteVolunteerParams = never;
...
/** Query 'GetStudentPartnerInfoById' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentPartnerInfoByIdResult = never;

/** Query 'GetStudentPartnerInfoById' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentPartnerInfoByIdParams = never;
...
/** Query 'DeleteStudent' is invalid, so its result is assigned type 'never'.
 *  */
export type IDeleteStudentResult = never;

/** Query 'DeleteStudent' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IDeleteStudentParams = never;
...
/** Query 'AdminUpdateStudent' is invalid, so its result is assigned type 'never'.
 *  */
export type IAdminUpdateStudentResult = never;

/** Query 'AdminUpdateStudent' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAdminUpdateStudentParams = never;
...
/** Query 'AdminUpdateStudentProfile' is invalid, so its result is assigned type 'never'.
 *  */
export type IAdminUpdateStudentProfileResult = never;

/** Query 'AdminUpdateStudentProfile' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAdminUpdateStudentProfileParams = never;
...
/** Query 'GetPartnerOrgsByStudent' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetPartnerOrgsByStudentResult = never;

/** Query 'GetPartnerOrgsByStudent' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetPartnerOrgsByStudentParams = never;
...
/** Query 'AdminDeactivateStudentPartnershipInstance' is invalid, so its result is assigned type 'never'.
 *  */
export type IAdminDeactivateStudentPartnershipInstanceResult = never;

/** Query 'AdminDeactivateStudentPartnershipInstance' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAdminDeactivateStudentPartnershipInstanceParams = never;
...
/** Query 'InsertStudentPartnershipInstance' is invalid, so its result is assigned type 'never'.
 *  */
export type IInsertStudentPartnershipInstanceResult = never;

/** Query 'InsertStudentPartnershipInstance' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IInsertStudentPartnershipInstanceParams = never;
...
/** Query 'UpdateStudentInGatesStudy' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpdateStudentInGatesStudyResult = never;

/** Query 'UpdateStudentInGatesStudy' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpdateStudentInGatesStudyParams = never;
...
/** Query 'CreateStudentUser' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateStudentUserResult = never;

/** Query 'CreateStudentUser' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateStudentUserParams = never;
...
/** Query 'CreateStudentProfile' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateStudentProfileResult = never;

/** Query 'CreateStudentProfile' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateStudentProfileParams = never;
...
/** Query 'UpsertStudentProfile' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpsertStudentProfileResult = never;

/** Query 'UpsertStudentProfile' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpsertStudentProfileParams = never;
...
/** Query 'CreateUserStudentPartnerOrgInstanceWithSchoolId' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateUserStudentPartnerOrgInstanceWithSchoolIdResult = never;

/** Query 'CreateUserStudentPartnerOrgInstanceWithSchoolId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateUserStudentPartnerOrgInstanceWithSchoolIdParams = never;
...
/** Query 'GetActiveStudentOrgInstance' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetActiveStudentOrgInstanceResult = never;

/** Query 'GetActiveStudentOrgInstance' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetActiveStudentOrgInstanceParams = never;
...
/** Query 'GetSessionReport' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetSessionReportResult = never;

/** Query 'GetSessionReport' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetSessionReportParams = never;
...
/** Query 'GetUsageReport' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetUsageReportResult = never;

/** Query 'GetUsageReport' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetUsageReportParams = never;
...
/** Query 'GetStudentSignupSources' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentSignupSourcesResult = never;

/** Query 'GetStudentSignupSources' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentSignupSourcesParams = never;
...
/** Query 'DeleteSelfFavoritedVolunteers' is invalid, so its result is assigned type 'never'.
 *  */
export type IDeleteSelfFavoritedVolunteersResult = never;

/** Query 'DeleteSelfFavoritedVolunteers' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IDeleteSelfFavoritedVolunteersParams = never;
...
/** Query 'UpdateStudentSchool' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpdateStudentSchoolResult = never;

/** Query 'UpdateStudentSchool' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpdateStudentSchoolParams = never;
...
/** Query 'GetActivePartnersForStudent' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetActivePartnersForStudentResult = never;

/** Query 'GetActivePartnersForStudent' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetActivePartnersForStudentParams = never;
...
/** Query 'GetStudentsIdsForGradeLevelSgUpdate' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentsIdsForGradeLevelSgUpdateResult = never;

/** Query 'GetStudentsIdsForGradeLevelSgUpdate' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentsIdsForGradeLevelSgUpdateParams = never;
...
/** Query 'CountDuplicateStudentVolunteerFavorites' is invalid, so its result is assigned type 'never'.
 *  */
export type ICountDuplicateStudentVolunteerFavoritesResult = never;

/** Query 'CountDuplicateStudentVolunteerFavorites' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICountDuplicateStudentVolunteerFavoritesParams = never;
...
/** Query 'DeleteDuplicateStudentVolunteerFavorites' is invalid, so its result is assigned type 'never'.
 *  */
export type IDeleteDuplicateStudentVolunteerFavoritesResult = never;

/** Query 'DeleteDuplicateStudentVolunteerFavorites' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IDeleteDuplicateStudentVolunteerFavoritesParams = never;
...
/** Query 'GetStudentProfilesByUserIds' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetStudentProfilesByUserIdsResult = never;

/** Query 'GetStudentProfilesByUserIds' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetStudentProfilesByUserIdsParams = never;
...
/** Query 'AddStudentToTeacherClass' is invalid, so its result is assigned type 'never'.
 *  */
export type IAddStudentToTeacherClassResult = never;

/** Query 'AddStudentToTeacherClass' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAddStudentToTeacherClassParams = never;
