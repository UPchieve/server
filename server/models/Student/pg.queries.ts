...
const createUserStudentPartnerOrgInstanceIR: any = {"name":"createUserStudentPartnerOrgInstance","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7752,"b":7758,"line":296,"col":5}]}},{"name":"spoName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7950,"b":7957,"line":304,"col":16}]}},{"name":"spoSiteName","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7970,"b":7980,"line":305,"col":11},{"a":8002,"b":8012,"line":305,"col":43}]}}],"usedParamSet":{"userId":true,"spoName":true,"spoSiteName":true},"statement":{"body":"INSERT INTO users_student_partner_orgs_instances (user_id, student_partner_org_id, student_partner_org_site_id, created_at, updated_at)\nSELECT\n    :userId!,\n    spo.id,\n    sposite.id,\n    NOW(),\n    NOW()\nFROM student_partner_orgs spo\nLEFT JOIN student_partner_org_sites sposite ON sposite.student_partner_org_id = spo.id\nWHERE \n    spo.name = :spoName!\n    and ((:spoSiteName)::text is null OR (:spoSiteName)::text = sposite.name)\nLIMIT 1\nRETURNING user_id as ok","loc":{"a":7604,"b":8067,"line":294,"col":0}}};
