...
/** 'GetPartnerOrgNamesByStudent' parameters type */
export interface IGetPartnerOrgNamesByStudentParams {
  studentId: string;
}

/** 'GetPartnerOrgNamesByStudent' return type */
export interface IGetPartnerOrgNamesByStudentResult {
  name: string;
}

/** 'GetPartnerOrgNamesByStudent' query type */
export interface IGetPartnerOrgNamesByStudentQuery {
  params: IGetPartnerOrgNamesByStudentParams;
  result: IGetPartnerOrgNamesByStudentResult;
}

const getPartnerOrgNamesByStudentIR: any = {"name":"getPartnerOrgNamesByStudent","params":[{"name":"studentId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":4916,"b":4925,"line":200,"col":21}]}}],"usedParamSet":{"studentId":true},"statement":{"body":"SELECT \n    spo.name\nFROM users_student_partner_orgs_instances uspoi\nJOIN student_partner_orgs spo ON spo.id = uspoi.student_partner_org_id\nWHERE \n    uspoi.user_id = :studentId!\n    AND deactivated_on IS NULL","loc":{"a":4748,"b":4956,"line":195,"col":0}}};
 ...
 * ```
 */
export const getPartnerOrgNamesByStudent = new PreparedQuery<IGetPartnerOrgNamesByStudentParams,IGetPartnerOrgNamesByStudentResult>(getPartnerOrgNamesByStudentIR);
...
const adminDeactivateStudentPartnershipInstanceIR: any = {"name":"adminDeactivateStudentPartnershipInstance","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":5102,"b":5108,"line":206,"col":17}]}},{"name":"spoId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":5140,"b":5145,"line":206,"col":55}]}}],"usedParamSet":{"userId":true,"spoId":true},"statement":{"body":"UPDATE users_student_partner_orgs_instances\nSET deactivated_on = NOW()\nWHERE user_id = :userId! AND student_partner_org_id = :spoId!\nRETURNING user_id AS ok","loc":{"a":5014,"b":5169,"line":204,"col":0}}};
...
/** 'AdminInsertStudentPartnershipInstance' parameters type */
export interface IAdminInsertStudentPartnershipInstanceParams {
  partnerOrgId: string;
  partnerOrgSiteId: string | null | void;
  userId: string;
}

/** 'AdminInsertStudentPartnershipInstance' return type */
export interface IAdminInsertStudentPartnershipInstanceResult {
  ok: string | null;
}

/** 'AdminInsertStudentPartnershipInstance' query type */
export interface IAdminInsertStudentPartnershipInstanceQuery {
  params: IAdminInsertStudentPartnershipInstanceParams;
  result: IAdminInsertStudentPartnershipInstanceResult;
}

const adminInsertStudentPartnershipInstanceIR: any = {"name":"adminInsertStudentPartnershipInstance","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":5368,"b":5374,"line":211,"col":9}]}},{"name":"partnerOrgId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":5378,"b":5390,"line":211,"col":19}]}},{"name":"partnerOrgSiteId","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":5394,"b":5409,"line":211,"col":35}]}}],"usedParamSet":{"userId":true,"partnerOrgId":true,"partnerOrgSiteId":true},"statement":{"body":"INSERT INTO users_student_partner_orgs_instances (user_id, student_partner_org_id, student_partner_org_site_id, created_at, updated_at)\nVALUES (:userId!, :partnerOrgId!, :partnerOrgSiteId, NOW(), NOW())\nRETURNING user_id AS ok","loc":{"a":5223,"b":5448,"line":210,"col":0}}};
 ...
 * ```
 */
export const adminInsertStudentPartnershipInstance = new PreparedQuery<IAdminInsertStudentPartnershipInstanceParams,IAdminInsertStudentPartnershipInstanceResult>(adminInsertStudentPartnershipInstanceIR);
...
const updateStudentInGatesStudyIR: any = {"name":"updateStudentInGatesStudy","params":[{"name":"inGatesStudy","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6252,"b":6263,"line":241,"col":31}]}},{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6303,"b":6309,"line":243,"col":15}]}}],"usedParamSet":{"inGatesStudy":true,"userId":true},"statement":{"body":"UPDATE\n    user_product_flags\nSET\n    in_gates_study = COALESCE(:inGatesStudy, in_gates_study)\nWHERE\n    user_id = :userId!\nRETURNING\n    user_id AS ok","loc":{"a":6187,"b":6337,"line":238,"col":0}}};
...
const createStudentUserIR: any = {"name":"createStudentUser","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6546,"b":6552,"line":250,"col":13}]}},{"name":"firstName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6556,"b":6565,"line":250,"col":23}]}},{"name":"lastName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6569,"b":6577,"line":250,"col":36}]}},{"name":"email","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6581,"b":6586,"line":250,"col":48}]}},{"name":"password","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6590,"b":6598,"line":250,"col":57}]}},{"name":"referredBy","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6609,"b":6618,"line":250,"col":76}]}},{"name":"referralCode","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6622,"b":6634,"line":250,"col":89}]}},{"name":"signupSourceId","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":6638,"b":6651,"line":250,"col":105}]}}],"usedParamSet":{"userId":true,"firstName":true,"lastName":true,"email":true,"password":true,"referredBy":true,"referralCode":true,"signupSourceId":true},"statement":{"body":"INSERT INTO users (id, first_name, last_name, email, PASSWORD, verified, referred_by, referral_code, signup_source_id, last_activity_at, created_at, updated_at)\n    VALUES (:userId!, :firstName!, :lastName!, :email!, :password!, FALSE, :referredBy, :referralCode!, :signupSourceId, NOW(), NOW(), NOW())\nON CONFLICT (email)\n    DO NOTHING\nRETURNING\n    id, first_name, last_name, email, verified, banned, test_user, deactivated, created_at","loc":{"a":6372,"b":6809,"line":249,"col":0}}};
...
const createStudentProfileIR: any = {"name":"createStudentProfile","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7024,"b":7030,"line":260,"col":5},{"a":7822,"b":7828,"line":287,"col":16}]}},{"name":"postalCode","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7038,"b":7047,"line":261,"col":5}]}},{"name":"schoolId","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7163,"b":7170,"line":265,"col":5}]}},{"name":"college","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7178,"b":7184,"line":266,"col":5}]}},{"name":"partnerOrg","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7617,"b":7626,"line":283,"col":40},{"a":7888,"b":7897,"line":291,"col":5}]}},{"name":"partnerSite","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7693,"b":7703,"line":284,"col":44},{"a":7928,"b":7938,"line":292,"col":5}]}},{"name":"gradeLevel","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":7769,"b":7778,"line":285,"col":31},{"a":7962,"b":7971,"line":293,"col":5}]}}],"usedParamSet":{"userId":true,"postalCode":true,"schoolId":true,"college":true,"partnerOrg":true,"partnerSite":true,"gradeLevel":true},"statement":{"body":"INSERT INTO student_profiles (user_id, postal_code, student_partner_org_id, student_partner_org_site_id, grade_level_id, school_id, college, created_at, updated_at)\nSELECT\n    :userId!,\n    :postalCode,\n    topquery.student_partner_org_id,\n    topquery.student_partner_org_site_id,\n    topquery.grade_level_id,\n    :schoolId,\n    :college,\n    NOW(),\n    NOW()\nFROM (\n    SELECT\n        subquery.student_partner_org_id AS student_partner_org_id,\n        student_partner_org_sites.id AS student_partner_org_site_id,\n        grade_levels.id AS grade_level_id\n    FROM\n        users\n    LEFT JOIN (\n        SELECT\n            id AS student_partner_org_id,\n            name\n        FROM\n            student_partner_orgs\n        WHERE\n            student_partner_orgs.key = :partnerOrg) AS subquery ON TRUE\n    LEFT JOIN student_partner_org_sites ON :partnerSite = student_partner_org_sites.name\n    LEFT JOIN grade_levels ON :gradeLevel = grade_levels.name\nWHERE\n    users.id = :userId!) AS topquery\nRETURNING\n    user_id,\n    postal_code,\n    :partnerOrg AS student_partner_org,\n    :partnerSite AS partner_site,\n    :gradeLevel AS grade_level,\n    school_id,\n    college,\n    created_at,\n    updated_at","loc":{"a":6847,"b":8046,"line":258,"col":0}}};
...
const createUserStudentPartnerOrgInstanceIR: any = {"name":"createUserStudentPartnerOrgInstance","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":8246,"b":8252,"line":302,"col":5}]}},{"name":"spoName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":8444,"b":8451,"line":310,"col":16}]}},{"name":"spoSiteName","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":8464,"b":8474,"line":311,"col":11},{"a":8496,"b":8506,"line":311,"col":43}]}}],"usedParamSet":{"userId":true,"spoName":true,"spoSiteName":true},"statement":{"body":"INSERT INTO users_student_partner_orgs_instances (user_id, student_partner_org_id, student_partner_org_site_id, created_at, updated_at)\nSELECT\n    :userId!,\n    spo.id,\n    sposite.id,\n    NOW(),\n    NOW()\nFROM student_partner_orgs spo\nLEFT JOIN student_partner_org_sites sposite ON sposite.student_partner_org_id = spo.id\nWHERE \n    spo.name = :spoName!\n    and ((:spoSiteName)::text is null OR (:spoSiteName)::text = sposite.name)\nLIMIT 1\nRETURNING user_id as ok","loc":{"a":8098,"b":8561,"line":300,"col":0}}};
