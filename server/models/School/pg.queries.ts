...
/** Query 'GetSchoolById' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetSchoolByIdResult = never;

/** Query 'GetSchoolById' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetSchoolByIdParams = never;
...
/** Query 'GetSchoolByNcesId' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetSchoolByNcesIdResult = never;

/** Query 'GetSchoolByNcesId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetSchoolByNcesIdParams = never;
...
/** Query 'GetSchools' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetSchoolsResult = never;

/** Query 'GetSchools' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetSchoolsParams = never;
...
/** Query 'SchoolSearch' is invalid, so its result is assigned type 'never'.
 *  */
export type ISchoolSearchResult = never;

/** Query 'SchoolSearch' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ISchoolSearchParams = never;
...
/** Query 'UpdateApproval' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpdateApprovalResult = never;

/** Query 'UpdateApproval' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpdateApprovalParams = never;
...
/** Query 'UpdateIsPartner' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpdateIsPartnerResult = never;

/** Query 'UpdateIsPartner' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpdateIsPartnerParams = never;
...
/** Query 'AdminUpdateSchool' is invalid, so its result is assigned type 'never'.
 *  */
export type IAdminUpdateSchoolResult = never;

/** Query 'AdminUpdateSchool' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAdminUpdateSchoolParams = never;
...
/** Query 'AdminUpdateSchoolMetaData' is invalid, so its result is assigned type 'never'.
 *  */
export type IAdminUpdateSchoolMetaDataResult = never;

/** Query 'AdminUpdateSchoolMetaData' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAdminUpdateSchoolMetaDataParams = never;
...
/** Query 'TitlecaseSchoolNames' is invalid, so its result is assigned type 'never'.
 *  */
export type ITitlecaseSchoolNamesResult = never;

/** Query 'TitlecaseSchoolNames' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ITitlecaseSchoolNamesParams = never;
...
/** Query 'TitlecaseMetadataSchoolNames' is invalid, so its result is assigned type 'never'.
 *  */
export type ITitlecaseMetadataSchoolNamesResult = never;

/** Query 'TitlecaseMetadataSchoolNames' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ITitlecaseMetadataSchoolNamesParams = never;
...
/** Query 'CreateSchool' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateSchoolResult = never;

/** Query 'CreateSchool' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateSchoolParams = never;
...
/** Query 'CreateSchoolMetadata' is invalid, so its result is assigned type 'never'.
 *  */
export type ICreateSchoolMetadataResult = never;

/** Query 'CreateSchoolMetadata' is invalid, so its parameters are assigned type 'never'.
 *  */
export type ICreateSchoolMetadataParams = never;
...
/** Query 'UpdateSchoolMetadata' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpdateSchoolMetadataResult = never;

/** Query 'UpdateSchoolMetadata' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpdateSchoolMetadataParams = never;
...
/** Query 'GetPartnerSchools' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetPartnerSchoolsResult = never;

/** Query 'GetPartnerSchools' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetPartnerSchoolsParams = never;
