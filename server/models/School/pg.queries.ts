...
const findSchoolByIdIR: any = {"name":"findSchoolById","params":[{"name":"schoolId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":335,"b":343,"line":15,"col":10}]}}],"usedParamSet":{"schoolId":true},"statement":{"body":"SELECT\n    schools.id,\n    schools.name AS name_stored,\n    approved AS is_approved,\n    partner AS is_partner,\n    schools.us_state_code AS state_stored,\n    created_at,\n    updated_at,\n    cities.name AS city_name_stored\nFROM\n    schools\n    LEFT JOIN cities ON schools.city_id = cities.id\nWHERE\n    id = :schoolId!","loc":{"a":27,"b":343,"line":2,"col":0}}};
