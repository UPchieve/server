...
const createUserIR: any = {"usedParamSet":{"id":true,"firstName":true,"lastName":true,"email":true,"proxyEmail":true,"phone":true,"password":true,"passwordResetToken":true,"verified":true,"emailVerified":true,"phoneVerified":true,"referralCode":true,"signupSourceId":true,"otherSignupSource":true},"params":[{"name":"id","required":true,"transform":{"type":"scalar"},"locs":[{"a":231,"b":234}]},{"name":"firstName","required":true,"transform":{"type":"scalar"},"locs":[{"a":237,"b":247}]},{"name":"lastName","required":true,"transform":{"type":"scalar"},"locs":[{"a":250,"b":259}]},{"name":"email","required":true,"transform":{"type":"scalar"},"locs":[{"a":262,"b":268}]},{"name":"proxyEmail","required":false,"transform":{"type":"scalar"},"locs":[{"a":271,"b":281}]},{"name":"phone","required":false,"transform":{"type":"scalar"},"locs":[{"a":284,"b":289}]},{"name":"password","required":false,"transform":{"type":"scalar"},"locs":[{"a":292,"b":300}]},{"name":"passwordResetToken","required":false,"transform":{"type":"scalar"},"locs":[{"a":303,"b":321}]},{"name":"verified","required":false,"transform":{"type":"scalar"},"locs":[{"a":324,"b":332}]},{"name":"emailVerified","required":false,"transform":{"type":"scalar"},"locs":[{"a":335,"b":348}]},{"name":"phoneVerified","required":false,"transform":{"type":"scalar"},"locs":[{"a":351,"b":364}]},{"name":"referralCode","required":true,"transform":{"type":"scalar"},"locs":[{"a":367,"b":380}]},{"name":"signupSourceId","required":false,"transform":{"type":"scalar"},"locs":[{"a":383,"b":397}]},{"name":"otherSignupSource","required":false,"transform":{"type":"scalar"},"locs":[{"a":400,"b":417}]}],"statement":"INSERT INTO users (id, first_name, last_name, email, proxy_email, phone, PASSWORD, password_reset_token, verified, email_verified, phone_verified, referral_code, signup_source_id, other_signup_source, last_activity_at)\n    VALUES (:id!, :firstName!, :lastName!, :email!, :proxyEmail, :phone, :password, :passwordResetToken, :verified, :emailVerified, :phoneVerified, :referralCode!, :signupSourceId, :otherSignupSource, NOW())\nON CONFLICT (email)\n    DO NOTHING\nRETURNING\n    id, email, first_name, proxy_email"};
