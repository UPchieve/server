...
/** Query 'InsertNthsGroupMemberRole' is invalid, so its result is assigned type 'never'.
 *  */
export type IInsertNthsGroupMemberRoleResult = never;

/** Query 'InsertNthsGroupMemberRole' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IInsertNthsGroupMemberRoleParams = never;
