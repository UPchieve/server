...
/** Query 'UpsertZipCode' is invalid, so its result is assigned type 'never'.
 *  */
export type IUpsertZipCodeResult = never;

/** Query 'UpsertZipCode' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IUpsertZipCodeParams = never;
