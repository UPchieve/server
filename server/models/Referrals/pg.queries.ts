...
/** Query 'AddReferral' is invalid, so its result is assigned type 'never'.
 *  */
export type IAddReferralResult = never;

/** Query 'AddReferral' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IAddReferralParams = never;
...
/** Query 'GetReferredUsersWithFilter' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetReferredUsersWithFilterResult = never;

/** Query 'GetReferredUsersWithFilter' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetReferredUsersWithFilterParams = never;
