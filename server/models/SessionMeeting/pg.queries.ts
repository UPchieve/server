...
/** Query 'GetSessionMeetingBySessionId' is invalid, so its result is assigned type 'never'.
 *  */
export type IGetSessionMeetingBySessionIdResult = never;

/** Query 'GetSessionMeetingBySessionId' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IGetSessionMeetingBySessionIdParams = never;
...
/** Query 'InsertSessionMeeting' is invalid, so its result is assigned type 'never'.
 *  */
export type IInsertSessionMeetingResult = never;

/** Query 'InsertSessionMeeting' is invalid, so its parameters are assigned type 'never'.
 *  */
export type IInsertSessionMeetingParams = never;
