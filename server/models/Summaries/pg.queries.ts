/** Types generated for queries found in "server/models/Summaries/summaries.sql" */
...
const getSessionSummariesBySessionIdIR: any = {"usedParamSet":{"sessionId":true},"params":[{"name":"sessionId","required":true,"transform":{"type":"scalar"},"locs":[{"a":116,"b":126}]}],"statement":"SELECT\n    id,\n    session_id,\n    summary,\n    user_type,\n    created_at\nFROM session_summaries\nWHERE session_id = :sessionId!"};
