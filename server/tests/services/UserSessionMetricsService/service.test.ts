...
import { updateSessionMetrics } from '../../../services/SessionService'
import {
...
} from '../../../services/UserSessionMetricsService/service'
...
describe('UserSessionMetricsService', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  })
  ...
  describe('computeSessionFlagsFromMetrics', () => {
    test('should return correct flags', () => {
      const metrics: Partial<SessionRepo.SessionMetrics> = {
        absentStudent: 1,
        absentVolunteer: 1,
      }
      ...
      const metricsTwo: Partial<SessionRepo.SessionMetrics> = {
        absentStudent: 0,
        absentVolunteer: 0,
      }
