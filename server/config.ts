...
const config: Static<typeof Config> = {
  ...
  certificatesStorageAccountName:
    process.env.SUBWAY_CERTIFICATES_STORAGE_ACCOUNT_NAME || 'bogus',
  certificatesStorageContainer:
    process.env.SUBWAY_CERTIFICATES_STORAGE_CONTAINER || 'bogus',
  certificatesFrontdoorHostName:
    process.env.SUBWAY_CERTIFICATES_FRONTDOOR_HOSTNAME || 'bogus',
