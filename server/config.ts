...
const config: Static<typeof Config> = {
  ...
  sendgrid: {
    ...
    fallIncentiveEnrollmentWelcomeTemplate: 'd-914f98ad37c3461eaacc1c2bf27f097d',
    fallIncentiveInvitedToEnrollReminderTemplate: 'd-ea8dadbc26f64da6bcdf7932049211d4',
    unsubscribeGroup: {
      newsletter: 12567,
      account: 12570,
