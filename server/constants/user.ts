...
export const EVENTS = <const>{
  ...
  ADDED_VOLUNTEER_ROLE: 'ADDED_VOLUNTEER_ROLE',
  HIGH_SCHOOL_COACH_EXCLUDED_FROM_COLLEGE_SESSION_TEXT_NOTIFICATION:
    'HIGH_SCHOOL_COACH_EXCLUDED_FROM_COLLEGE_SESSION_TEXT_NOTIFICATION',
  STUDENT_SUBMITTED_ESSAY_FOR_REVIEW: 'STUDENT_SUBMITTED_ESSAY_FOR_REVIEW',
  VOLUNTEER_SUBMITTED_ESSAY_REVIEW: 'VOLUNTEER_SUBMITTED_ESSAY_REVIEW',
  VOLUNTEER_UPDATED_ESSAY_REVIEW_EMAIL_OPT_IN:
    'VOLUNTEER_UPDATED_ESSAY_REVIEW_EMAIL_OPT_IN',
  VOLUNTEER_NOTIFIED_ABOUT_ESSAY_REVIEW_SUBMISSION:
    'VOLUNTEER_NOTIFIED_ABOUT_ESSAY_REVIEW_SUBMISSION',
  ADMIN_SENT_ESSAY_REVIEWS_TO_STUDENT: 'ADMIN_SENT_ESSAY_REVIEWS_TO_STUDENT',
  STUDENT_ESSAY_REVIEWS_SENT: 'STUDENT_ESSAY_REVIEWS_SENT',
  NTHS_APPLICATION_APPROVED: 'NTHS_APPLICATION_APPROVED',
  NTHS_APPLICATION_DENIED: 'NTHS_APPLICATION_DENIED',
}
