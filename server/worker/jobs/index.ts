...
import backfillUsersSchools from './backfillUsersSchools'
...
export enum Jobs {
  ...
  BackfillUsersSchools = 'BackfillUsersSchools',
}
...
const jobProcessors: JobProcessor[] = [
  ...
  {
    name: Jobs.BackfillUsersSchools,
    processor: backfillUsersSchools,
  },
]
