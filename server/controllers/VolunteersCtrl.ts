 ...
 * @param {*} aggAvailabilities
 */
export function findMinAndMax(aggAvailabilities: any) {
 ...
 * @param {*} callback
 */
export async function getVolunteersAvailability(options: any, callback: Function) {
 ...
 * @param {*} callback
 */
export function getVolunteers(callback: Function) {
