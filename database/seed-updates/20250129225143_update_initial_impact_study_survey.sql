...
FROM
    ...
    CROSS JOIN UNNEST(ARRAY[
        ...
        'What scale is your GPA on?',
        'What course is your lowest grade in (please be specific in the course name)?',
        'How many AP courses are you taking this year?',
        'How many IB courses are you taking this year?',
        'How many Dual enrollment courses are you taking this year?',
        'How many Honors courses are you taking this year?'
    ]) AS sub(text)
WHERE
...
FROM
    upchieve.question_types qt
    CROSS JOIN UNNEST(ARRAY[
        'Do you know your current high school GPA?',
        'What is your closest estimate of your current grades in school?',
        'What is your lowest grade?',
        'What subject is your lowest grade in?',
        'Will you be the first person in your family to attend college?',
        'Are you or have you ever been eligible for free or reduced price lunch at school?',
...
VALUES
    (0, 'I''m not sure / Prefer not to answer', NOW(), NOW()),
    (0, 'A''s', NOW(), NOW()),
    (0, 'A''s and B''s', NOW(), NOW()),
    (0, 'B''s', NOW(), NOW()),
    (0, 'B''s and C''s', NOW(), NOW()),
    (0, 'C''s', NOW(), NOW()),
    (0, 'C''s and D''s', NOW(), NOW()),
    (0, 'D''s', NOW(), NOW()),
    (0, 'D''s and below', NOW(), NOW()),
    (0, 'Math', NOW(), NOW()),
    (0, 'English', NOW(), NOW()),
    (0, 'Science', NOW(), NOW()),
    (0, 'Social Studies', NOW(), NOW()),
    (0, 'Foreign Language', NOW(), NOW()),
    (0, 'American Indian / Alaska Native', NOW(), NOW()),
    (0, 'Asian', NOW(), NOW()),
    (0, 'Black or African American', NOW(), NOW()),
    (0, 'Hispanic or Latinx', NOW(), NOW()),
    (0, 'Native Hawaiian / Pacific Islander', NOW(), NOW()),
    (0, 'Middle Eastern or North African', NOW(), NOW()),
    (0, 'White', NOW(), NOW()),
    (0, 'Prefer not to answer', NOW(), NOW());

INSERT INTO upchieve.surveys_survey_questions (
    survey_id,
    survey_question_id,
    display_priority,
    created_at,
...
SELECT
    ...
    sq.id,
    CASE
        WHEN sq.question_text = 'Do you know your current high school GPA?' THEN 10
        WHEN sq.question_text = 'What is your current high school GPA?' THEN 20
        WHEN sq.question_text = 'What scale is your GPA on?' THEN 30
        WHEN sq.question_text = 'What is your closest estimate of your current grades in school?' THEN 40
        WHEN sq.question_text = 'What is your lowest grade?' THEN 50
        WHEN sq.question_text = 'What subject is your lowest grade in?' THEN 60
        WHEN sq.question_text = 'What course is your lowest grade in (please be specific in the course name)?' THEN 70
        WHEN sq.question_text = 'How many AP courses are you taking this year?' THEN 80
        WHEN sq.question_text = 'How many IB courses are you taking this year?' THEN 90
        WHEN sq.question_text = 'How many Dual enrollment courses are you taking this year?' THEN 100
        WHEN sq.question_text = 'How many Honors courses are you taking this year?' THEN 110
        WHEN sq.question_text = 'What is your ethnicity? (Select all that apply)' THEN 120
        WHEN sq.question_text = 'Will you be the first person in your family to attend college?' THEN 130
        WHEN sq.question_text = 'Are you or have you ever been eligible for free or reduced price lunch at school?' THEN 140
        WHEN sq.question_text = 'Do you primarily speak English at home?' THEN 150
        WHEN sq.question_text = 'Do you have an IEP or 504 plan?' THEN 160
        ELSE 0
    END AS priority,
    NOW(),
    NOW()
FROM
    upchieve.surveys s
    JOIN upchieve.survey_questions sq ON sq.question_text IN (
        'Do you know your current high school GPA?',
        'What is your current high school GPA?',
        'What scale is your GPA on?',
        'What is your closest estimate of your current grades in school?',
...
INSERT INTO upchieve.survey_questions_response_choices (
...
WHERE choice_text IN (
    'I''m not sure / Prefer not to answer',
    'A''s',
    'A''s and B''s',
    'B''s',
    'B''s and C''s',
