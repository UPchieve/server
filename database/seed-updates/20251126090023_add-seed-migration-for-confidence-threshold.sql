...
-- migrate:down
DELETE FROM upchieve.contextual_moderation_confidence_thresholds
WHERE flag_reason IN ('PII', 'HATE_SPEECH', 'PLATFORM_CIRCUMVENTION', 'INAPPROPRIATE_CONTENT', 'SAFETY');
