-- migrate:up
INSERT INTO upchieve.topics (name, icon_link, color, dashboard_order, training_order, display_name, created_at, updated_at)
    VALUES ('socialStudies', NULL, NULL, 6, 4, 'Social Studies', NOW(), NOW());
