-- migrate:up
CREATE upchieve.user_session_metrics_view AS
...
COUNT(*) FILTER (WHERE flag_name = 'Personally identifiable information' OR flag_name = 'PII') AS personal_identifying_info,
