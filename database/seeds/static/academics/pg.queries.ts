...
const insertQuizSubcategoryIR: any = {"name":"insertQuizSubcategory","params":[{"name":"quizId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":653,"b":659,"line":11,"col":80}]}},{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":663,"b":667,"line":11,"col":90}]}}],"usedParamSet":{"quizId":true,"name":true},"statement":{"body":"INSERT INTO quiz_subcategories (quiz_id, name, created_at, updated_at) VALUES (:quizId!, :name!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING id AS ok","loc":{"a":573,"b":724,"line":11,"col":0}}};
...
const insertQuizQuestionIR: any = {"name":"insertQuizQuestion","params":[{"name":"correctAnswer","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":890,"b":903,"line":14,"col":131}]}},{"name":"possibleAnswers","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":907,"b":922,"line":14,"col":148}]}},{"name":"subCategoryId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":926,"b":939,"line":14,"col":167}]}},{"name":"questionText","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":943,"b":955,"line":14,"col":184}]}}],"usedParamSet":{"correctAnswer":true,"possibleAnswers":true,"subCategoryId":true,"questionText":true},"statement":{"body":"INSERT INTO quiz_questions (correct_answer, possible_answers, quiz_subcategory_id, question_text, created_at, updated_at) VALUES (:correctAnswer!, :possibleAnswers!, :subCategoryId!, :questionText!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING id AS ok","loc":{"a":759,"b":1012,"line":14,"col":0}}};
...
const insertSubjectIR: any = {"name":"insertSubject","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1156,"b":1160,"line":17,"col":114}]}},{"name":"displayName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1164,"b":1175,"line":17,"col":122}]}},{"name":"displayOrder","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1179,"b":1191,"line":17,"col":137}]}},{"name":"toolTypeId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1195,"b":1205,"line":17,"col":153}]}},{"name":"topicId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1209,"b":1216,"line":17,"col":167}]}}],"usedParamSet":{"name":true,"displayName":true,"displayOrder":true,"toolTypeId":true,"topicId":true},"statement":{"body":"INSERT INTO subjects (name, display_name, display_order, tool_type_id, topic_id, created_at, updated_at) VALUES (:name!, :displayName!, :displayOrder!, :toolTypeId!, :topicId!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING id AS ok","loc":{"a":1042,"b":1273,"line":17,"col":0}}};
...
const insertCertificationSubjectUnlocksIR: any = {"name":"insertCertificationSubjectUnlocks","params":[{"name":"certificationId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1429,"b":1444,"line":20,"col":106}]}},{"name":"subjectId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1448,"b":1457,"line":20,"col":125}]}}],"usedParamSet":{"certificationId":true,"subjectId":true},"statement":{"body":"INSERT INTO certification_subject_unlocks (certification_id, subject_id, created_at, updated_at) VALUES (:certificationId!, :subjectId!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING subject_id AS ok","loc":{"a":1323,"b":1522,"line":20,"col":0}}};
...
const insertToolTypeIR: any = {"name":"insertToolType","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1616,"b":1620,"line":23,"col":63}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO tool_types (name, created_at, updated_at) VALUES (:name!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING id AS ok","loc":{"a":1553,"b":1677,"line":23,"col":0}}};
...
const insertTopicIR: any = {"name":"insertTopic","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1795,"b":1799,"line":26,"col":90}]}},{"name":"displayName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1803,"b":1814,"line":26,"col":98}]}},{"name":"dashboardOrder","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1818,"b":1832,"line":26,"col":113}]}}],"usedParamSet":{"name":true,"displayName":true,"dashboardOrder":true},"statement":{"body":"INSERT INTO topics (name, display_name, dashboard_order, created_at, updated_at) VALUES (:name!, :displayName!, :dashboardOrder!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING id AS ok","loc":{"a":1705,"b":1889,"line":26,"col":0}}};
...
const insertTrainingCourseIR: any = {"name":"insertTrainingCourse","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1995,"b":1999,"line":29,"col":69}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO training_courses (name, created_at, updated_at) VALUES (:name!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING name AS ok","loc":{"a":1926,"b":2058,"line":29,"col":0}}};
