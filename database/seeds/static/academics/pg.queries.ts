...
const insertCertificationIR: any = {"name":"insertCertification","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":103,"b":107,"line":3,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO certifications (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":32,"b":172,"line":2,"col":0}}};
...
const insertQuizIR: any = {"name":"insertQuiz","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":264,"b":268,"line":12,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO quizzes (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":200,"b":333,"line":11,"col":0}}};
...
const insertCertificationGrantIR: any = {"name":"insertCertificationGrant","params":[{"name":"quizId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":478,"b":484,"line":21,"col":13}]}},{"name":"certificationId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":488,"b":503,"line":21,"col":23}]}}],"usedParamSet":{"quizId":true,"certificationId":true},"statement":{"body":"INSERT INTO quiz_certification_grants (quiz_id, certification_id, created_at, updated_at)\n    VALUES (:quizId!, :certificationId!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    quiz_id AS ok","loc":{"a":375,"b":573,"line":20,"col":0}}};
...
const insertQuizSubcategoryIR: any = {"name":"insertQuizSubcategory","params":[{"name":"quizId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":696,"b":702,"line":30,"col":13}]}},{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":706,"b":710,"line":30,"col":23}]}}],"usedParamSet":{"quizId":true,"name":true},"statement":{"body":"INSERT INTO quiz_subcategories (quiz_id, name, created_at, updated_at)\n    VALUES (:quizId!, :name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":612,"b":775,"line":29,"col":0}}};
...
const insertQuizQuestionIR: any = {"name":"insertQuizQuestion","params":[{"name":"correctAnswer","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":946,"b":959,"line":39,"col":13}]}},{"name":"possibleAnswers","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":963,"b":978,"line":39,"col":30}]}},{"name":"subCategoryId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":982,"b":995,"line":39,"col":49}]}},{"name":"questionText","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":999,"b":1011,"line":39,"col":66}]}}],"usedParamSet":{"correctAnswer":true,"possibleAnswers":true,"subCategoryId":true,"questionText":true},"statement":{"body":"INSERT INTO quiz_questions (correct_answer, possible_answers, quiz_subcategory_id, question_text, created_at, updated_at)\n    VALUES (:correctAnswer!, :possibleAnswers!, :subCategoryId!, :questionText!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":811,"b":1076,"line":38,"col":0}}};
...
const insertSubjectIR: any = {"name":"insertSubject","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1225,"b":1229,"line":48,"col":13}]}},{"name":"displayName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1233,"b":1244,"line":48,"col":21}]}},{"name":"displayOrder","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1248,"b":1260,"line":48,"col":36}]}},{"name":"toolTypeId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1264,"b":1274,"line":48,"col":52}]}},{"name":"topicId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1278,"b":1285,"line":48,"col":66}]}}],"usedParamSet":{"name":true,"displayName":true,"displayOrder":true,"toolTypeId":true,"topicId":true},"statement":{"body":"INSERT INTO subjects (name, display_name, display_order, tool_type_id, topic_id, created_at, updated_at)\n    VALUES (:name!, :displayName!, :displayOrder!, :toolTypeId!, :topicId!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":1107,"b":1350,"line":47,"col":0}}};
...
const insertCertificationSubjectUnlocksIR: any = {"name":"insertCertificationSubjectUnlocks","params":[{"name":"certificationId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1511,"b":1526,"line":57,"col":13}]}},{"name":"subjectId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1530,"b":1539,"line":57,"col":32}]}}],"usedParamSet":{"certificationId":true,"subjectId":true},"statement":{"body":"INSERT INTO certification_subject_unlocks (certification_id, subject_id, created_at, updated_at)\n    VALUES (:certificationId!, :subjectId!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    subject_id AS ok","loc":{"a":1401,"b":1612,"line":56,"col":0}}};
...
const insertToolTypeIR: any = {"name":"insertToolType","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1711,"b":1715,"line":66,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO tool_types (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":1644,"b":1780,"line":65,"col":0}}};
...
const insertTopicIR: any = {"name":"insertTopic","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1903,"b":1907,"line":75,"col":13}]}},{"name":"displayName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1911,"b":1922,"line":75,"col":21}]}},{"name":"dashboardOrder","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1926,"b":1940,"line":75,"col":36}]}}],"usedParamSet":{"name":true,"displayName":true,"dashboardOrder":true},"statement":{"body":"INSERT INTO topics (name, display_name, dashboard_order, created_at, updated_at)\n    VALUES (:name!, :displayName!, :dashboardOrder!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":1809,"b":2005,"line":74,"col":0}}};
...
const insertTrainingCourseIR: any = {"name":"insertTrainingCourse","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2116,"b":2120,"line":84,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO training_courses (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    name AS ok","loc":{"a":2043,"b":2187,"line":83,"col":0}}};
