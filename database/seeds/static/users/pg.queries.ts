...
const insertBanReasonIR: any = {"name":"insertBanReason","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":96,"b":100,"line":3,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO ban_reasons (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":28,"b":165,"line":2,"col":0}}};
...
const insertGradeLevelIR: any = {"name":"insertGradeLevel","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":268,"b":272,"line":12,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO grade_levels (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":199,"b":337,"line":11,"col":0}}};
...
const insertPhotoIdStatusIR: any = {"name":"insertPhotoIdStatus","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":448,"b":452,"line":21,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO photo_id_statuses (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":374,"b":517,"line":20,"col":0}}};
...
const insertSignupSourceIR: any = {"name":"insertSignupSource","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":624,"b":628,"line":30,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO signup_sources (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":553,"b":693,"line":29,"col":0}}};
...
const insertUserRoleIR: any = {"name":"insertUserRole","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":792,"b":796,"line":39,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO user_roles (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":725,"b":861,"line":38,"col":0}}};
...
const insertVolunteerReferenceStatusIR: any = {"name":"insertVolunteerReferenceStatus","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":994,"b":998,"line":48,"col":13}]}}],"usedParamSet":{"name":true},"statement":{"body":"INSERT INTO volunteer_reference_statuses (name, created_at, updated_at)\n    VALUES (:name!, NOW(), NOW())\nON CONFLICT\n    DO NOTHING\nRETURNING\n    id AS ok","loc":{"a":909,"b":1063,"line":47,"col":0}}};
