...
import { studentPartnerOrgsReal } from './scripts/partners/student-partner-orgs-real'
import { studentPartnerOrgSitesReal } from './scripts/partners/student-partner-org-sites-real'
import { volunteerPartnerOrgsReal } from './scripts/partners/volunteer-partner-orgs-real'
import { requiredEmailDomainsReal } from './scripts/partners/required-email-domains-real'
import { sponsorOrgsReal, schoolsSponsorOrgsReal, studentPartnerOrgsSponsorOrgsReal } from './scripts/partners/sponsor-orgs-real'
import { associatedPartnersReal } from './scripts/partners/associated-partners-real'
...
async function seedData(): Promise<void> {
  ...
  try {
    ...
    const spoIds = await studentPartnerOrgsReal()
    await studentPartnerOrgSitesReal(spoIds)
