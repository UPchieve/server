...
const insertVolunteerProfileIR: any = {"name":"insertVolunteerProfile","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1648,"b":1654,"line":50,"col":140}]}},{"name":"timezone","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1658,"b":1666,"line":50,"col":150}]}},{"name":"approved","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1670,"b":1678,"line":50,"col":162}]}},{"name":"onboarded","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1682,"b":1691,"line":50,"col":174}]}},{"name":"college","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1695,"b":1702,"line":50,"col":187}]}},{"name":"volunteerPartnerOrgId","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1706,"b":1726,"line":50,"col":198}]}}],"usedParamSet":{"userId":true,"timezone":true,"approved":true,"onboarded":true,"college":true,"volunteerPartnerOrgId":true},"statement":{"body":"INSERT INTO volunteer_profiles (user_id, timezone, approved, onboarded, college, volunteer_partner_org_id, created_at, updated_at) VALUES (:userId!, :timezone!, :approved!, :onboarded!, :college!, :volunteerPartnerOrgId, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING user_id AS ok","loc":{"a":1508,"b":1788,"line":50,"col":0}}};
...
const insertUserCertificationIR: any = {"name":"insertUserCertification","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1922,"b":1928,"line":53,"col":94}]}},{"name":"certificationId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":1932,"b":1947,"line":53,"col":104}]}}],"usedParamSet":{"userId":true,"certificationId":true},"statement":{"body":"INSERT INTO users_certifications (user_id, certification_id, created_at, updated_at) VALUES (:userId!, :certificationId!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING user_id AS ok","loc":{"a":1828,"b":2009,"line":53,"col":0}}};
...
const insertIntoUserQuizzesIR: any = {"name":"insertIntoUserQuizzes","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2143,"b":2149,"line":56,"col":96}]}},{"name":"quizId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2153,"b":2159,"line":56,"col":106}]}},{"name":"attempts","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2163,"b":2171,"line":56,"col":116}]}},{"name":"passed","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2175,"b":2181,"line":56,"col":128}]}}],"usedParamSet":{"userId":true,"quizId":true,"attempts":true,"passed":true},"statement":{"body":"INSERT INTO users_quizzes (user_id, quiz_id, attempts, passed, created_at, updated_at) VALUES (:userId!, :quizId!, :attempts!, :passed!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING user_id AS ok","loc":{"a":2047,"b":2243,"line":56,"col":0}}};
...
const insertAdminProfileIR: any = {"name":"insertAdminProfile","params":[{"name":"userId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2348,"b":2354,"line":59,"col":70}]}}],"usedParamSet":{"userId":true},"statement":{"body":"INSERT INTO admin_profiles (user_id, created_at, updated_at) VALUES (:userId!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING user_id AS ok","loc":{"a":2278,"b":2416,"line":59,"col":0}}};
...
const insertSessionIR: any = {"name":"insertSession","params":[{"name":"id","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2543,"b":2545,"line":62,"col":97}]}},{"name":"studentId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2549,"b":2558,"line":62,"col":103}]}},{"name":"volunteerId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2562,"b":2573,"line":62,"col":116}]}},{"name":"subjectId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2577,"b":2586,"line":62,"col":131}]}}],"usedParamSet":{"id":true,"studentId":true,"volunteerId":true,"subjectId":true},"statement":{"body":"INSERT INTO sessions (id, student_id, volunteer_id, subject_id, created_at, updated_at) VALUES (:id!, :studentId!, :volunteerId!, :subjectId!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING id AS ok","loc":{"a":2446,"b":2643,"line":62,"col":0}}};
...
const insertStudentFavoriteVolunteersIR: any = {"name":"insertStudentFavoriteVolunteers","params":[{"name":"studentId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2791,"b":2800,"line":65,"col":100}]}},{"name":"volunteerId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":2804,"b":2815,"line":65,"col":113}]}}],"usedParamSet":{"studentId":true,"volunteerId":true},"statement":{"body":"INSERT INTO student_favorite_volunteers (student_id, volunteer_id, created_at, updated_at) VALUES (:studentId!, :volunteerId!, NOW(), NOW()) ON CONFLICT DO NOTHING RETURNING student_id AS ok","loc":{"a":2691,"b":2880,"line":65,"col":0}}};
...
const getCertificationsIR: any = {"name":"getCertifications","params":[],"usedParamSet":{},"statement":{"body":"SELECT id, name FROM certifications","loc":{"a":3096,"b":3130,"line":80,"col":0}}};
...
const getQuizzesIR: any = {"name":"getQuizzes","params":[],"usedParamSet":{},"statement":{"body":"SELECT id, name FROM quizzes","loc":{"a":3157,"b":3184,"line":83,"col":0}}};
...
const getAlgebraOneSubcategoriesIR: any = {"name":"getAlgebraOneSubcategories","params":[],"usedParamSet":{},"statement":{"body":"SELECT qs.id, qs.name FROM quiz_subcategories qs JOIN quizzes q ON q.id = qs.quiz_id WHERE q.name = 'algebraOne'","loc":{"a":3227,"b":3338,"line":86,"col":0}}};
...
const insertQuizQuestionIR: any = {"name":"insertQuizQuestion","params":[{"name":"questionText","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3504,"b":3516,"line":90,"col":9}]}},{"name":"possibleAnswers","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3520,"b":3535,"line":90,"col":25}]}},{"name":"correctAnswer","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3539,"b":3552,"line":90,"col":44}]}},{"name":"quizSubcategoryId","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3556,"b":3573,"line":90,"col":61}]}}],"usedParamSet":{"questionText":true,"possibleAnswers":true,"correctAnswer":true,"quizSubcategoryId":true},"statement":{"body":"INSERT INTO quiz_questions (question_text, possible_answers, correct_answer, quiz_subcategory_id, created_at, updated_at)\nVALUES (:questionText!, :possibleAnswers!, :correctAnswer!, :quizSubcategoryId!, NOW(), NOW())\nRETURNING id AS ok","loc":{"a":3373,"b":3607,"line":89,"col":0}}};
...
const insertCityIR: any = {"name":"insertCity","params":[{"name":"name","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3708,"b":3712,"line":95,"col":9}]}},{"name":"usStateCode","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3716,"b":3727,"line":95,"col":17}]}}],"usedParamSet":{"name":true,"usStateCode":true},"statement":{"body":"INSERT INTO cities (name, us_state_code, created_at, updated_at)\nVALUES (:name!, :usStateCode!, NOW(), NOW())\nRETURNING id as ok","loc":{"a":3634,"b":3761,"line":94,"col":0}}};
...
const insertUserProductFlagsIR: any = {"name":"insertUserProductFlags","params":[{"name":"id","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":3875,"b":3877,"line":101,"col":9}]}}],"usedParamSet":{"id":true},"statement":{"body":"INSERT INTO user_product_flags (user_id, created_at, updated_at)\nVALUES (:id!, NOW(), NOW())\nRETURNING user_id AS ok","loc":{"a":3801,"b":3916,"line":100,"col":0}}};
