...
--
-- Name: upchieve_old; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA upchieve_old;
...
--
-- Name: admin_profiles; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.admin_profiles (
    user_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
);
...
--
-- Name: assistments_data; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.assistments_data (
    id uuid NOT NULL,
    problem_id integer NOT NULL,
    assignment_id uuid NOT NULL,
    student_id uuid NOT NULL,
...
--
-- Name: associated_partners; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.associated_partners (
    id uuid NOT NULL,
    key text NOT NULL,
    volunteer_partner_org_id uuid NOT NULL,
    student_partner_org_id uuid,
...
--
-- Name: availabilities; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.availabilities (
    id uuid NOT NULL,
    user_id uuid NOT NULL,
    weekday_id integer NOT NULL,
    available_start smallint NOT NULL,
...
--
-- Name: availability_histories; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.availability_histories (
    id uuid NOT NULL,
    user_id uuid NOT NULL,
    weekday_id integer NOT NULL,
    available_start smallint NOT NULL,
...
--
-- Name: ban_reasons; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.ban_reasons (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: ban_reasons_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.ban_reasons_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ban_reasons_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.ban_reasons_id_seq OWNED BY upchieve_old.ban_reasons.id;


--
-- Name: certification_subject_unlocks; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.certification_subject_unlocks (
    subject_id integer NOT NULL,
    certification_id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: certifications; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.certifications (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: certifications_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.certifications_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: certifications_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.certifications_id_seq OWNED BY upchieve_old.certifications.id;


--
-- Name: cities; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.cities (
    id integer NOT NULL,
    name text NOT NULL,
    us_state_code character varying(2),
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: cities_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.cities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cities_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.cities_id_seq OWNED BY upchieve_old.cities.id;


--
-- Name: contact_form_submissions; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.contact_form_submissions (
    id uuid NOT NULL,
    user_id uuid NOT NULL,
    user_email text,
    message text NOT NULL,
...
--
-- Name: feedbacks; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.feedbacks (
    id uuid NOT NULL,
    topic_id integer,
    subject_id integer,
    user_role_id integer NOT NULL,
...
--
-- Name: grade_levels; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.grade_levels (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: grade_levels_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.grade_levels_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: grade_levels_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.grade_levels_id_seq OWNED BY upchieve_old.grade_levels.id;


--
-- Name: ineligible_students; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.ineligible_students (
    id uuid NOT NULL,
    email text NOT NULL,
    postal_code text,
    ip_address_id bigint,
...
--
-- Name: ip_addresses; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.ip_addresses (
    id bigint NOT NULL,
    ip inet NOT NULL,
    status text,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: ip_addresses_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.ip_addresses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ip_addresses_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.ip_addresses_id_seq OWNED BY upchieve_old.ip_addresses.id;


--
-- Name: legacy_availability_histories; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.legacy_availability_histories (
    id uuid NOT NULL,
    mongo_id character varying(26) NOT NULL,
    user_id uuid,
    timezone text,
...
--
-- Name: notification_methods; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.notification_methods (
    id integer NOT NULL,
    method text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: notification_methods_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.notification_methods_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: notification_methods_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.notification_methods_id_seq OWNED BY upchieve_old.notification_methods.id;


--
-- Name: notification_priority_groups; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.notification_priority_groups (
    id integer NOT NULL,
    name text NOT NULL,
    priority smallint NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: notification_priority_groups_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.notification_priority_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: notification_priority_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.notification_priority_groups_id_seq OWNED BY upchieve_old.notification_priority_groups.id;


--
-- Name: notification_types; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.notification_types (
    id integer NOT NULL,
    type text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: notification_types_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.notification_types_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: notification_types_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.notification_types_id_seq OWNED BY upchieve_old.notification_types.id;


--
-- Name: notifications; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.notifications (
    id uuid NOT NULL,
    user_id uuid NOT NULL,
    sent_at timestamp with time zone,
    type_id integer NOT NULL,
...
--
-- Name: photo_id_statuses; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.photo_id_statuses (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: photo_id_statuses_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.photo_id_statuses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: photo_id_statuses_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.photo_id_statuses_id_seq OWNED BY upchieve_old.photo_id_statuses.id;


--
-- Name: postal_codes; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.postal_codes (
    code text NOT NULL,
    us_state_code character varying(2),
    income integer,
    location point,
...
--
-- Name: pre_session_surveys; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.pre_session_surveys (
    id uuid NOT NULL,
    response_data jsonb,
    session_id uuid NOT NULL,
    user_id uuid NOT NULL,
...
--
-- Name: push_tokens; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.push_tokens (
    id uuid NOT NULL,
    user_id uuid NOT NULL,
    token text NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: quiz_certification_grants; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.quiz_certification_grants (
    quiz_id integer NOT NULL,
    certification_id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: quiz_questions; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.quiz_questions (
    id integer NOT NULL,
    question_text text NOT NULL,
    possible_answers jsonb,
    correct_answer text NOT NULL,
...
--
-- Name: quiz_questions_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.quiz_questions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: quiz_questions_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.quiz_questions_id_seq OWNED BY upchieve_old.quiz_questions.id;


--
-- Name: quiz_subcategories; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.quiz_subcategories (
    id integer NOT NULL,
    name text NOT NULL,
    quiz_id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: quiz_subcategories_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.quiz_subcategories_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: quiz_subcategories_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.quiz_subcategories_id_seq OWNED BY upchieve_old.quiz_subcategories.id;


--
-- Name: quizzes; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.quizzes (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: quizzes_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.quizzes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: quizzes_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.quizzes_id_seq OWNED BY upchieve_old.quizzes.id;


--
-- Name: report_reasons; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.report_reasons (
    id integer NOT NULL,
    reason text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: report_reasons_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.report_reasons_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: report_reasons_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.report_reasons_id_seq OWNED BY upchieve_old.report_reasons.id;


--
-- Name: required_email_domains; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.required_email_domains (
    id uuid NOT NULL,
    domain text NOT NULL,
    volunteer_partner_org_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: school_nces_metadata; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.school_nces_metadata (
    school_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
    school_year text,
...
--
-- Name: schools; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.schools (
    id uuid NOT NULL,
    name text NOT NULL,
    approved boolean DEFAULT false NOT NULL,
    partner boolean DEFAULT false NOT NULL,
...
--
-- Name: schools_sponsor_orgs; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.schools_sponsor_orgs (
    school_id uuid NOT NULL,
    sponsor_org_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: session_failed_joins; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.session_failed_joins (
    session_id uuid NOT NULL,
    user_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: session_flags; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.session_flags (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: session_flags_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.session_flags_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: session_flags_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.session_flags_id_seq OWNED BY upchieve_old.session_flags.id;


--
-- Name: session_messages; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.session_messages (
    id uuid NOT NULL,
    sender_id uuid NOT NULL,
    contents text NOT NULL,
    session_id uuid NOT NULL,
...
--
-- Name: session_photos; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.session_photos (
    session_id uuid NOT NULL,
    photo_key text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: session_reports; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.session_reports (
    id uuid NOT NULL,
    report_reason_id integer NOT NULL,
    report_message text,
    reporting_user_id uuid NOT NULL,
...
--
-- Name: session_review_reasons; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.session_review_reasons (
    session_id uuid NOT NULL,
    session_flag_id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: sessions; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.sessions (
    id uuid NOT NULL,
    student_id uuid NOT NULL,
    volunteer_id uuid,
    subject_id integer NOT NULL,
...
--
-- Name: sessions_session_flags; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.sessions_session_flags (
    session_id uuid NOT NULL,
    session_flag_id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: signup_sources; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.signup_sources (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: signup_sources_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.signup_sources_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: signup_sources_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.signup_sources_id_seq OWNED BY upchieve_old.signup_sources.id;


--
-- Name: sponsor_orgs; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.sponsor_orgs (
    id uuid NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
...
--
-- Name: student_favorite_volunteers; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.student_favorite_volunteers (
    student_id uuid NOT NULL,
    volunteer_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: student_partner_org_sites; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.student_partner_org_sites (
    id uuid NOT NULL,
    name text NOT NULL,
    student_partner_org_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: student_partner_orgs; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.student_partner_orgs (
    id uuid NOT NULL,
    key text NOT NULL,
    name text NOT NULL,
    signup_code text,
...
--
-- Name: student_partner_orgs_sponsor_orgs; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.student_partner_orgs_sponsor_orgs (
    student_partner_org_id uuid NOT NULL,
    sponsor_org_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: student_profiles; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.student_profiles (
    user_id uuid NOT NULL,
    college text,
    school_id uuid,
    postal_code text,
...
--
-- Name: subjects; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.subjects (
    id integer NOT NULL,
    name text NOT NULL,
    display_name text NOT NULL,
    display_order integer NOT NULL,
...
--
-- Name: subjects_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.subjects_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: subjects_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.subjects_id_seq OWNED BY upchieve_old.subjects.id;


--
-- Name: tool_types; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.tool_types (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: tool_types_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.tool_types_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: tool_types_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.tool_types_id_seq OWNED BY upchieve_old.tool_types.id;


--
-- Name: topics; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.topics (
    id integer NOT NULL,
    name text NOT NULL,
    icon_link text,
    color text,
...
--
-- Name: topics_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.topics_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: topics_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.topics_id_seq OWNED BY upchieve_old.topics.id;


--
-- Name: training_courses; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.training_courses (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: training_courses_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.training_courses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: training_courses_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.training_courses_id_seq OWNED BY upchieve_old.training_courses.id;


--
-- Name: us_states; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.us_states (
    code character varying(2) NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: user_actions; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.user_actions (
    id bigint NOT NULL,
    user_id uuid NOT NULL,
    session_id uuid,
    action_type text,
...
--
-- Name: user_actions_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.user_actions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_actions_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.user_actions_id_seq OWNED BY upchieve_old.user_actions.id;


--
-- Name: user_product_flags; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.user_product_flags (
    user_id uuid NOT NULL,
    sent_ready_to_coach_email boolean DEFAULT false NOT NULL,
    sent_hour_summary_intro_email boolean DEFAULT false NOT NULL,
    sent_inactive_thirty_day_email boolean DEFAULT false NOT NULL,
...
--
-- Name: user_roles; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.user_roles (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: user_roles_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.user_roles_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: user_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.user_roles_id_seq OWNED BY upchieve_old.user_roles.id;


--
-- Name: user_session_metrics; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.user_session_metrics (
    user_id uuid NOT NULL,
    absent_student integer DEFAULT 0 NOT NULL,
    absent_volunteer integer DEFAULT 0 NOT NULL,
    low_session_rating_from_coach integer DEFAULT 0 NOT NULL,
...
--
-- Name: users; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.users (
    id uuid NOT NULL,
    verified boolean DEFAULT false NOT NULL,
    email_verified boolean DEFAULT false NOT NULL,
    phone_verified boolean DEFAULT false NOT NULL,
...
--
-- Name: users_certifications; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.users_certifications (
    user_id uuid NOT NULL,
    certification_id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: users_ip_addresses; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.users_ip_addresses (
    id uuid NOT NULL,
    ip_address_id integer NOT NULL,
    user_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: users_quizzes; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.users_quizzes (
    user_id uuid NOT NULL,
    quiz_id integer NOT NULL,
    attempts integer DEFAULT 0 NOT NULL,
    passed boolean DEFAULT false NOT NULL,
...
--
-- Name: users_roles; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.users_roles (
    user_id uuid NOT NULL,
    role_id integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: users_training_courses; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.users_training_courses (
    user_id uuid NOT NULL,
    training_course_id integer NOT NULL,
    complete boolean DEFAULT false NOT NULL,
    progress smallint DEFAULT 0 NOT NULL,
...
--
-- Name: volunteer_occupations; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.volunteer_occupations (
    user_id uuid NOT NULL,
    occupation text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: volunteer_partner_orgs; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.volunteer_partner_orgs (
    id uuid NOT NULL,
    key text NOT NULL,
    name text NOT NULL,
    receive_weekly_hour_summary_email boolean DEFAULT false NOT NULL,
...
--
-- Name: volunteer_profiles; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.volunteer_profiles (
    user_id uuid NOT NULL,
    volunteer_partner_org_id uuid,
    timezone text NOT NULL,
    approved boolean DEFAULT false NOT NULL,
...
--
-- Name: volunteer_reference_statuses; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.volunteer_reference_statuses (
    id integer NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: volunteer_reference_statuses_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.volunteer_reference_statuses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: volunteer_reference_statuses_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.volunteer_reference_statuses_id_seq OWNED BY upchieve_old.volunteer_reference_statuses.id;


--
-- Name: volunteer_references; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.volunteer_references (
    id uuid NOT NULL,
    user_id uuid NOT NULL,
    first_name text NOT NULL,
    last_name text NOT NULL,
...
--
-- Name: weekdays; Type: TABLE; Schema: upchieve_old; Owner: -
--

CREATE TABLE upchieve_old.weekdays (
    id integer NOT NULL,
    day text NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL
...
--
-- Name: weekdays_id_seq; Type: SEQUENCE; Schema: upchieve_old; Owner: -
--

CREATE SEQUENCE upchieve_old.weekdays_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: weekdays_id_seq; Type: SEQUENCE OWNED BY; Schema: upchieve_old; Owner: -
--

ALTER SEQUENCE upchieve_old.weekdays_id_seq OWNED BY upchieve_old.weekdays.id;
...
--
-- Name: ban_reasons id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ban_reasons ALTER COLUMN id SET DEFAULT nextval('upchieve_old.ban_reasons_id_seq'::regclass);


--
-- Name: certifications id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.certifications ALTER COLUMN id SET DEFAULT nextval('upchieve_old.certifications_id_seq'::regclass);


--
-- Name: cities id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.cities ALTER COLUMN id SET DEFAULT nextval('upchieve_old.cities_id_seq'::regclass);


--
-- Name: grade_levels id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.grade_levels ALTER COLUMN id SET DEFAULT nextval('upchieve_old.grade_levels_id_seq'::regclass);


--
-- Name: ip_addresses id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ip_addresses ALTER COLUMN id SET DEFAULT nextval('upchieve_old.ip_addresses_id_seq'::regclass);


--
-- Name: notification_methods id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notification_methods ALTER COLUMN id SET DEFAULT nextval('upchieve_old.notification_methods_id_seq'::regclass);


--
-- Name: notification_priority_groups id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notification_priority_groups ALTER COLUMN id SET DEFAULT nextval('upchieve_old.notification_priority_groups_id_seq'::regclass);


--
-- Name: notification_types id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notification_types ALTER COLUMN id SET DEFAULT nextval('upchieve_old.notification_types_id_seq'::regclass);


--
-- Name: photo_id_statuses id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.photo_id_statuses ALTER COLUMN id SET DEFAULT nextval('upchieve_old.photo_id_statuses_id_seq'::regclass);


--
-- Name: quiz_questions id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_questions ALTER COLUMN id SET DEFAULT nextval('upchieve_old.quiz_questions_id_seq'::regclass);


--
-- Name: quiz_subcategories id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_subcategories ALTER COLUMN id SET DEFAULT nextval('upchieve_old.quiz_subcategories_id_seq'::regclass);


--
-- Name: quizzes id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quizzes ALTER COLUMN id SET DEFAULT nextval('upchieve_old.quizzes_id_seq'::regclass);


--
-- Name: report_reasons id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.report_reasons ALTER COLUMN id SET DEFAULT nextval('upchieve_old.report_reasons_id_seq'::regclass);


--
-- Name: session_flags id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_flags ALTER COLUMN id SET DEFAULT nextval('upchieve_old.session_flags_id_seq'::regclass);


--
-- Name: signup_sources id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.signup_sources ALTER COLUMN id SET DEFAULT nextval('upchieve_old.signup_sources_id_seq'::regclass);


--
-- Name: subjects id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.subjects ALTER COLUMN id SET DEFAULT nextval('upchieve_old.subjects_id_seq'::regclass);


--
-- Name: tool_types id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.tool_types ALTER COLUMN id SET DEFAULT nextval('upchieve_old.tool_types_id_seq'::regclass);


--
-- Name: topics id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.topics ALTER COLUMN id SET DEFAULT nextval('upchieve_old.topics_id_seq'::regclass);


--
-- Name: training_courses id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.training_courses ALTER COLUMN id SET DEFAULT nextval('upchieve_old.training_courses_id_seq'::regclass);


--
-- Name: user_actions id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_actions ALTER COLUMN id SET DEFAULT nextval('upchieve_old.user_actions_id_seq'::regclass);


--
-- Name: user_roles id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_roles ALTER COLUMN id SET DEFAULT nextval('upchieve_old.user_roles_id_seq'::regclass);


--
-- Name: volunteer_reference_statuses id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_reference_statuses ALTER COLUMN id SET DEFAULT nextval('upchieve_old.volunteer_reference_statuses_id_seq'::regclass);


--
-- Name: weekdays id; Type: DEFAULT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.weekdays ALTER COLUMN id SET DEFAULT nextval('upchieve_old.weekdays_id_seq'::regclass);
...
--
-- Name: admin_profiles admin_profiles_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.admin_profiles
    ADD CONSTRAINT admin_profiles_pkey PRIMARY KEY (user_id);


--
-- Name: assistments_data assistments_data_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.assistments_data
    ADD CONSTRAINT assistments_data_mongo_id_key UNIQUE (mongo_id);


--
-- Name: assistments_data assistments_data_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: associated_partners associated_partners_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.associated_partners
    ADD CONSTRAINT associated_partners_pkey PRIMARY KEY (id);


--
-- Name: availabilities availabilities_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.availabilities
    ADD CONSTRAINT availabilities_pkey PRIMARY KEY (id);


--
-- Name: availability_histories availability_histories_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.availability_histories
    ADD CONSTRAINT availability_histories_pkey PRIMARY KEY (id);


--
-- Name: ban_reasons ban_reasons_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ban_reasons
    ADD CONSTRAINT ban_reasons_name_key UNIQUE (name);


--
-- Name: ban_reasons ban_reasons_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: certification_subject_unlocks certification_subject_unlocks_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.certification_subject_unlocks
    ADD CONSTRAINT certification_subject_unlocks_pkey PRIMARY KEY (subject_id, certification_id);


--
-- Name: certifications certifications_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.certifications
    ADD CONSTRAINT certifications_name_key UNIQUE (name);


--
-- Name: certifications certifications_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: cities cities_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.cities
    ADD CONSTRAINT cities_name_key UNIQUE (name);


--
-- Name: cities cities_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: contact_form_submissions contact_form_submissions_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.contact_form_submissions
    ADD CONSTRAINT contact_form_submissions_pkey PRIMARY KEY (id);


--
-- Name: feedbacks feedbacks_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.feedbacks
    ADD CONSTRAINT feedbacks_mongo_id_key UNIQUE (mongo_id);


--
-- Name: feedbacks feedbacks_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: grade_levels grade_levels_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.grade_levels
    ADD CONSTRAINT grade_levels_name_key UNIQUE (name);


--
-- Name: grade_levels grade_levels_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: ineligible_students ineligible_students_email_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ineligible_students
    ADD CONSTRAINT ineligible_students_email_key UNIQUE (email);


--
-- Name: ineligible_students ineligible_students_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: ineligible_students ineligible_students_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: ip_addresses ip_addresses_ip_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ip_addresses
    ADD CONSTRAINT ip_addresses_ip_key UNIQUE (ip);


--
-- Name: ip_addresses ip_addresses_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: ip_addresses ip_addresses_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: legacy_availability_histories legacy_availability_histories_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.legacy_availability_histories
    ADD CONSTRAINT legacy_availability_histories_pkey PRIMARY KEY (id);


--
-- Name: quiz_subcategories name_quiz_id; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_subcategories
    ADD CONSTRAINT name_quiz_id UNIQUE (name, quiz_id);


--
-- Name: notification_methods notification_methods_method_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notification_methods
    ADD CONSTRAINT notification_methods_method_key UNIQUE (method);


--
-- Name: notification_methods notification_methods_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: notification_priority_groups notification_priority_groups_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notification_priority_groups
    ADD CONSTRAINT notification_priority_groups_name_key UNIQUE (name);


--
-- Name: notification_priority_groups notification_priority_groups_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: notification_types notification_types_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notification_types
    ADD CONSTRAINT notification_types_pkey PRIMARY KEY (id);


--
-- Name: notification_types notification_types_type_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: notifications notifications_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notifications
    ADD CONSTRAINT notifications_mongo_id_key UNIQUE (mongo_id);


--
-- Name: notifications notifications_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: photo_id_statuses photo_id_statuses_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.photo_id_statuses
    ADD CONSTRAINT photo_id_statuses_name_key UNIQUE (name);


--
-- Name: photo_id_statuses photo_id_statuses_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: postal_codes postal_codes_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.postal_codes
    ADD CONSTRAINT postal_codes_pkey PRIMARY KEY (code);


--
-- Name: pre_session_surveys pre_session_surveys_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.pre_session_surveys
    ADD CONSTRAINT pre_session_surveys_mongo_id_key UNIQUE (mongo_id);


--
-- Name: pre_session_surveys pre_session_surveys_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: pre_session_surveys pre_session_surveys_session_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: push_tokens push_tokens_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.push_tokens
    ADD CONSTRAINT push_tokens_pkey PRIMARY KEY (id);


--
-- Name: quiz_certification_grants quiz_certification_grants_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_certification_grants
    ADD CONSTRAINT quiz_certification_grants_pkey PRIMARY KEY (certification_id, quiz_id);


--
-- Name: quiz_questions quiz_questions_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_questions
    ADD CONSTRAINT quiz_questions_mongo_id_key UNIQUE (mongo_id);


--
-- Name: quiz_questions quiz_questions_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: quiz_subcategories quiz_subcategories_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: quizzes quizzes_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quizzes
    ADD CONSTRAINT quizzes_name_key UNIQUE (name);


--
-- Name: quizzes quizzes_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: report_reasons report_reasons_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.report_reasons
    ADD CONSTRAINT report_reasons_pkey PRIMARY KEY (id);


--
-- Name: report_reasons report_reasons_reason_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: required_email_domains required_email_domains_domain_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.required_email_domains
    ADD CONSTRAINT required_email_domains_domain_key UNIQUE (domain);


--
-- Name: required_email_domains required_email_domains_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: school_nces_metadata school_nces_metadata_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.school_nces_metadata
    ADD CONSTRAINT school_nces_metadata_pkey PRIMARY KEY (school_id);


--
-- Name: schools schools_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.schools
    ADD CONSTRAINT schools_mongo_id_key UNIQUE (mongo_id);


--
-- Name: schools schools_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: schools_sponsor_orgs schools_sponsor_orgs_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.schools_sponsor_orgs
    ADD CONSTRAINT schools_sponsor_orgs_pkey PRIMARY KEY (school_id, sponsor_org_id);


--
-- Name: session_flags session_flags_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_flags
    ADD CONSTRAINT session_flags_name_key UNIQUE (name);


--
-- Name: session_flags session_flags_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: session_messages session_messages_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_messages
    ADD CONSTRAINT session_messages_mongo_id_key UNIQUE (mongo_id);


--
-- Name: session_messages session_messages_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: session_reports session_reports_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_reports
    ADD CONSTRAINT session_reports_pkey PRIMARY KEY (id);


--
-- Name: session_review_reasons session_review_reasons_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_review_reasons
    ADD CONSTRAINT session_review_reasons_pkey PRIMARY KEY (session_id, session_flag_id);


--
-- Name: sessions sessions_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions
    ADD CONSTRAINT sessions_mongo_id_key UNIQUE (mongo_id);


--
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: sessions_session_flags sessions_session_flags_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions_session_flags
    ADD CONSTRAINT sessions_session_flags_pkey PRIMARY KEY (session_id, session_flag_id);


--
-- Name: signup_sources signup_sources_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.signup_sources
    ADD CONSTRAINT signup_sources_name_key UNIQUE (name);


--
-- Name: signup_sources signup_sources_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: sponsor_orgs sponsor_orgs_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sponsor_orgs
    ADD CONSTRAINT sponsor_orgs_pkey PRIMARY KEY (id);


--
-- Name: student_partner_org_sites student_partner_org_sites_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_partner_org_sites
    ADD CONSTRAINT student_partner_org_sites_name_key UNIQUE (name);


--
-- Name: student_partner_org_sites student_partner_org_sites_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: student_partner_orgs student_partner_orgs_key_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_partner_orgs
    ADD CONSTRAINT student_partner_orgs_key_key UNIQUE (key);


--
-- Name: student_partner_orgs student_partner_orgs_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: student_partner_orgs student_partner_orgs_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: student_partner_orgs student_partner_orgs_signup_code_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: student_partner_orgs_sponsor_orgs student_partner_orgs_sponsor_orgs_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_partner_orgs_sponsor_orgs
    ADD CONSTRAINT student_partner_orgs_sponsor_orgs_pkey PRIMARY KEY (student_partner_org_id, sponsor_org_id);


--
-- Name: student_profiles student_profiles_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_profiles
    ADD CONSTRAINT student_profiles_pkey PRIMARY KEY (user_id);


--
-- Name: subjects subjects_display_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.subjects
    ADD CONSTRAINT subjects_display_name_key UNIQUE (display_name);


--
-- Name: subjects subjects_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: subjects subjects_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: tool_types tool_types_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.tool_types
    ADD CONSTRAINT tool_types_name_key UNIQUE (name);


--
-- Name: tool_types tool_types_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: topics topics_dashboard_order_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.topics
    ADD CONSTRAINT topics_dashboard_order_key UNIQUE (dashboard_order);


--
-- Name: topics topics_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: topics topics_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: training_courses training_courses_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.training_courses
    ADD CONSTRAINT training_courses_name_key UNIQUE (name);


--
-- Name: training_courses training_courses_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: schools unique_name__state_code_city_id; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: users_ip_addresses unique_user_id_ip_address_id; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_ip_addresses
    ADD CONSTRAINT unique_user_id_ip_address_id UNIQUE (user_id, ip_address_id);


--
-- Name: volunteer_occupations unique_user_id_occupation; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_occupations
    ADD CONSTRAINT unique_user_id_occupation UNIQUE (user_id, occupation);


--
-- Name: us_states us_states_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.us_states
    ADD CONSTRAINT us_states_name_key UNIQUE (name);


--
-- Name: us_states us_states_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: user_actions user_actions_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_actions
    ADD CONSTRAINT user_actions_mongo_id_key UNIQUE (mongo_id);


--
-- Name: user_actions user_actions_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: volunteer_references user_id_ref_email_unique; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_references
    ADD CONSTRAINT user_id_ref_email_unique UNIQUE (user_id, email);


--
-- Name: users_training_courses user_id_training_course_id_unique; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_training_courses
    ADD CONSTRAINT user_id_training_course_id_unique UNIQUE (user_id, training_course_id);


--
-- Name: user_product_flags user_product_flags_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_product_flags
    ADD CONSTRAINT user_product_flags_pkey PRIMARY KEY (user_id);


--
-- Name: user_roles user_roles_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_roles
    ADD CONSTRAINT user_roles_name_key UNIQUE (name);


--
-- Name: user_roles user_roles_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: user_session_metrics user_session_metrics_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_session_metrics
    ADD CONSTRAINT user_session_metrics_pkey PRIMARY KEY (user_id);


--
-- Name: users_certifications users_certifications_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_certifications
    ADD CONSTRAINT users_certifications_pkey PRIMARY KEY (user_id, certification_id);


--
-- Name: users users_email_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users
    ADD CONSTRAINT users_email_key UNIQUE (email);


--
-- Name: users_ip_addresses users_ip_addresses_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: users users_mongo_id_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: users_quizzes users_quizzes_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_quizzes
    ADD CONSTRAINT users_quizzes_pkey PRIMARY KEY (user_id, quiz_id);


--
-- Name: users users_referral_code_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: users_roles users_roles_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_roles
    ADD CONSTRAINT users_roles_pkey PRIMARY KEY (user_id, role_id);


--
-- Name: users_training_courses users_training_courses_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: volunteer_partner_orgs volunteer_partner_orgs_key_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_partner_orgs
    ADD CONSTRAINT volunteer_partner_orgs_key_key UNIQUE (key);


--
-- Name: volunteer_partner_orgs volunteer_partner_orgs_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: volunteer_partner_orgs volunteer_partner_orgs_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: volunteer_profiles volunteer_profiles_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_profiles
    ADD CONSTRAINT volunteer_profiles_pkey PRIMARY KEY (user_id);


--
-- Name: volunteer_reference_statuses volunteer_reference_statuses_name_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_reference_statuses
    ADD CONSTRAINT volunteer_reference_statuses_name_key UNIQUE (name);


--
-- Name: volunteer_reference_statuses volunteer_reference_statuses_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: volunteer_references volunteer_references_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: weekdays weekdays_day_key; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.weekdays
    ADD CONSTRAINT weekdays_day_key UNIQUE (day);


--
-- Name: weekdays weekdays_pkey; Type: CONSTRAINT; Schema: upchieve_old; Owner: -
--
...
--
-- Name: name_search_idx; Type: INDEX; Schema: upchieve_old; Owner: -
--

CREATE INDEX name_search_idx ON upchieve_old.schools USING gin (name_search);
...
--
-- Name: admin_profiles admin_profiles_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.admin_profiles
    ADD CONSTRAINT admin_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: assistments_data assistments_data_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.assistments_data
    ADD CONSTRAINT assistments_data_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: associated_partners associated_partners_student_partner_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.associated_partners
    ADD CONSTRAINT associated_partners_student_partner_org_id_fkey FOREIGN KEY (student_partner_org_id) REFERENCES upchieve_old.student_partner_orgs(id);


--
-- Name: associated_partners associated_partners_student_sponsor_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.associated_partners
    ADD CONSTRAINT associated_partners_student_sponsor_org_id_fkey FOREIGN KEY (student_sponsor_org_id) REFERENCES upchieve_old.sponsor_orgs(id);


--
-- Name: associated_partners associated_partners_volunteer_partner_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.associated_partners
    ADD CONSTRAINT associated_partners_volunteer_partner_org_id_fkey FOREIGN KEY (volunteer_partner_org_id) REFERENCES upchieve_old.volunteer_partner_orgs(id);


--
-- Name: availabilities availabilities_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.availabilities
    ADD CONSTRAINT availabilities_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: availabilities availabilities_weekday_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.availabilities
    ADD CONSTRAINT availabilities_weekday_id_fkey FOREIGN KEY (weekday_id) REFERENCES upchieve_old.weekdays(id);


--
-- Name: availability_histories availability_histories_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.availability_histories
    ADD CONSTRAINT availability_histories_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: availability_histories availability_histories_weekday_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.availability_histories
    ADD CONSTRAINT availability_histories_weekday_id_fkey FOREIGN KEY (weekday_id) REFERENCES upchieve_old.weekdays(id);


--
-- Name: certification_subject_unlocks certification_subject_unlocks_certification_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.certification_subject_unlocks
    ADD CONSTRAINT certification_subject_unlocks_certification_id_fkey FOREIGN KEY (certification_id) REFERENCES upchieve_old.certifications(id);


--
-- Name: certification_subject_unlocks certification_subject_unlocks_subject_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.certification_subject_unlocks
    ADD CONSTRAINT certification_subject_unlocks_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES upchieve_old.subjects(id);


--
-- Name: cities cities_us_state_code_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.cities
    ADD CONSTRAINT cities_us_state_code_fkey FOREIGN KEY (us_state_code) REFERENCES upchieve_old.us_states(code);


--
-- Name: contact_form_submissions contact_form_submissions_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.contact_form_submissions
    ADD CONSTRAINT contact_form_submissions_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: feedbacks feedbacks_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.feedbacks
    ADD CONSTRAINT feedbacks_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: feedbacks feedbacks_subject_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.feedbacks
    ADD CONSTRAINT feedbacks_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES upchieve_old.subjects(id);


--
-- Name: feedbacks feedbacks_topic_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.feedbacks
    ADD CONSTRAINT feedbacks_topic_id_fkey FOREIGN KEY (topic_id) REFERENCES upchieve_old.topics(id);


--
-- Name: feedbacks feedbacks_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.feedbacks
    ADD CONSTRAINT feedbacks_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: feedbacks feedbacks_user_role_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.feedbacks
    ADD CONSTRAINT feedbacks_user_role_id_fkey FOREIGN KEY (user_role_id) REFERENCES upchieve_old.user_roles(id);


--
-- Name: ineligible_students ineligible_students_grade_level_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ineligible_students
    ADD CONSTRAINT ineligible_students_grade_level_id_fkey FOREIGN KEY (grade_level_id) REFERENCES upchieve_old.grade_levels(id);


--
-- Name: ineligible_students ineligible_students_ip_address_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ineligible_students
    ADD CONSTRAINT ineligible_students_ip_address_id_fkey FOREIGN KEY (ip_address_id) REFERENCES upchieve_old.ip_addresses(id);


--
-- Name: ineligible_students ineligible_students_postal_code_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ineligible_students
    ADD CONSTRAINT ineligible_students_postal_code_fkey FOREIGN KEY (postal_code) REFERENCES upchieve_old.postal_codes(code);


--
-- Name: ineligible_students ineligible_students_school_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.ineligible_students
    ADD CONSTRAINT ineligible_students_school_id_fkey FOREIGN KEY (school_id) REFERENCES upchieve_old.schools(id);


--
-- Name: legacy_availability_histories legacy_availability_histories_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.legacy_availability_histories
    ADD CONSTRAINT legacy_availability_histories_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: notifications notifications_method_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notifications
    ADD CONSTRAINT notifications_method_id_fkey FOREIGN KEY (method_id) REFERENCES upchieve_old.notification_methods(id);


--
-- Name: notifications notifications_priority_group_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notifications
    ADD CONSTRAINT notifications_priority_group_id_fkey FOREIGN KEY (priority_group_id) REFERENCES upchieve_old.notification_priority_groups(id);


--
-- Name: notifications notifications_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notifications
    ADD CONSTRAINT notifications_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: notifications notifications_type_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notifications
    ADD CONSTRAINT notifications_type_id_fkey FOREIGN KEY (type_id) REFERENCES upchieve_old.notification_types(id);


--
-- Name: notifications notifications_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.notifications
    ADD CONSTRAINT notifications_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: postal_codes postal_codes_us_state_code_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.postal_codes
    ADD CONSTRAINT postal_codes_us_state_code_fkey FOREIGN KEY (us_state_code) REFERENCES upchieve_old.us_states(code);


--
-- Name: pre_session_surveys pre_session_surveys_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.pre_session_surveys
    ADD CONSTRAINT pre_session_surveys_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: pre_session_surveys pre_session_surveys_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.pre_session_surveys
    ADD CONSTRAINT pre_session_surveys_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: push_tokens push_tokens_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.push_tokens
    ADD CONSTRAINT push_tokens_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: quiz_certification_grants quiz_certification_grants_certification_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_certification_grants
    ADD CONSTRAINT quiz_certification_grants_certification_id_fkey FOREIGN KEY (certification_id) REFERENCES upchieve_old.certifications(id);


--
-- Name: quiz_certification_grants quiz_certification_grants_quiz_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_certification_grants
    ADD CONSTRAINT quiz_certification_grants_quiz_id_fkey FOREIGN KEY (quiz_id) REFERENCES upchieve_old.quizzes(id);


--
-- Name: quiz_questions quiz_questions_quiz_subcategory_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_questions
    ADD CONSTRAINT quiz_questions_quiz_subcategory_id_fkey FOREIGN KEY (quiz_subcategory_id) REFERENCES upchieve_old.quiz_subcategories(id);


--
-- Name: quiz_subcategories quiz_subcategories_quiz_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.quiz_subcategories
    ADD CONSTRAINT quiz_subcategories_quiz_id_fkey FOREIGN KEY (quiz_id) REFERENCES upchieve_old.quizzes(id);


--
-- Name: required_email_domains required_email_domains_volunteer_partner_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.required_email_domains
    ADD CONSTRAINT required_email_domains_volunteer_partner_org_id_fkey FOREIGN KEY (volunteer_partner_org_id) REFERENCES upchieve_old.volunteer_partner_orgs(id);


--
-- Name: school_nces_metadata school_nces_metadata_school_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.school_nces_metadata
    ADD CONSTRAINT school_nces_metadata_school_id_fkey FOREIGN KEY (school_id) REFERENCES upchieve_old.schools(id);


--
-- Name: schools schools_city_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.schools
    ADD CONSTRAINT schools_city_id_fkey FOREIGN KEY (city_id) REFERENCES upchieve_old.cities(id);


--
-- Name: schools_sponsor_orgs schools_sponsor_orgs_school_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.schools_sponsor_orgs
    ADD CONSTRAINT schools_sponsor_orgs_school_id_fkey FOREIGN KEY (school_id) REFERENCES upchieve_old.schools(id);


--
-- Name: schools_sponsor_orgs schools_sponsor_orgs_sponsor_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.schools_sponsor_orgs
    ADD CONSTRAINT schools_sponsor_orgs_sponsor_org_id_fkey FOREIGN KEY (sponsor_org_id) REFERENCES upchieve_old.sponsor_orgs(id);


--
-- Name: schools schools_us_state_code_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.schools
    ADD CONSTRAINT schools_us_state_code_fkey FOREIGN KEY (us_state_code) REFERENCES upchieve_old.us_states(code);


--
-- Name: session_failed_joins session_failed_joins_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_failed_joins
    ADD CONSTRAINT session_failed_joins_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: session_failed_joins session_failed_joins_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_failed_joins
    ADD CONSTRAINT session_failed_joins_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: session_messages session_messages_sender_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_messages
    ADD CONSTRAINT session_messages_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES upchieve_old.users(id);


--
-- Name: session_messages session_messages_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_messages
    ADD CONSTRAINT session_messages_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: session_photos session_photos_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_photos
    ADD CONSTRAINT session_photos_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: session_reports session_reports_report_reason_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_reports
    ADD CONSTRAINT session_reports_report_reason_id_fkey FOREIGN KEY (report_reason_id) REFERENCES upchieve_old.report_reasons(id);


--
-- Name: session_reports session_reports_reported_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_reports
    ADD CONSTRAINT session_reports_reported_user_id_fkey FOREIGN KEY (reported_user_id) REFERENCES upchieve_old.users(id);


--
-- Name: session_reports session_reports_reporting_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_reports
    ADD CONSTRAINT session_reports_reporting_user_id_fkey FOREIGN KEY (reporting_user_id) REFERENCES upchieve_old.users(id);


--
-- Name: session_reports session_reports_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_reports
    ADD CONSTRAINT session_reports_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: session_review_reasons session_review_reasons_session_flag_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_review_reasons
    ADD CONSTRAINT session_review_reasons_session_flag_id_fkey FOREIGN KEY (session_flag_id) REFERENCES upchieve_old.session_flags(id);


--
-- Name: session_review_reasons session_review_reasons_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.session_review_reasons
    ADD CONSTRAINT session_review_reasons_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: sessions sessions_ended_by_role_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions
    ADD CONSTRAINT sessions_ended_by_role_id_fkey FOREIGN KEY (ended_by_role_id) REFERENCES upchieve_old.user_roles(id);


--
-- Name: sessions_session_flags sessions_session_flags_session_flag_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions_session_flags
    ADD CONSTRAINT sessions_session_flags_session_flag_id_fkey FOREIGN KEY (session_flag_id) REFERENCES upchieve_old.session_flags(id);


--
-- Name: sessions_session_flags sessions_session_flags_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions_session_flags
    ADD CONSTRAINT sessions_session_flags_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: sessions sessions_student_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions
    ADD CONSTRAINT sessions_student_id_fkey FOREIGN KEY (student_id) REFERENCES upchieve_old.users(id);


--
-- Name: sessions sessions_subject_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions
    ADD CONSTRAINT sessions_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES upchieve_old.subjects(id);


--
-- Name: sessions sessions_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.sessions
    ADD CONSTRAINT sessions_volunteer_id_fkey FOREIGN KEY (volunteer_id) REFERENCES upchieve_old.users(id);


--
-- Name: student_favorite_volunteers student_favorite_volunteers_student_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_favorite_volunteers
    ADD CONSTRAINT student_favorite_volunteers_student_id_fkey FOREIGN KEY (student_id) REFERENCES upchieve_old.users(id);


--
-- Name: student_favorite_volunteers student_favorite_volunteers_volunteer_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_favorite_volunteers
    ADD CONSTRAINT student_favorite_volunteers_volunteer_id_fkey FOREIGN KEY (volunteer_id) REFERENCES upchieve_old.users(id);


--
-- Name: student_partner_org_sites student_partner_org_sites_student_partner_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_partner_org_sites
    ADD CONSTRAINT student_partner_org_sites_student_partner_org_id_fkey FOREIGN KEY (student_partner_org_id) REFERENCES upchieve_old.student_partner_orgs(id);


--
-- Name: student_partner_orgs_sponsor_orgs student_partner_orgs_sponsor_orgs_sponsor_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_partner_orgs_sponsor_orgs
    ADD CONSTRAINT student_partner_orgs_sponsor_orgs_sponsor_org_id_fkey FOREIGN KEY (sponsor_org_id) REFERENCES upchieve_old.sponsor_orgs(id);


--
-- Name: student_partner_orgs_sponsor_orgs student_partner_orgs_sponsor_orgs_student_partner_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_partner_orgs_sponsor_orgs
    ADD CONSTRAINT student_partner_orgs_sponsor_orgs_student_partner_org_id_fkey FOREIGN KEY (student_partner_org_id) REFERENCES upchieve_old.student_partner_orgs(id);


--
-- Name: student_profiles student_profiles_grade_level_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_profiles
    ADD CONSTRAINT student_profiles_grade_level_id_fkey FOREIGN KEY (grade_level_id) REFERENCES upchieve_old.grade_levels(id);


--
-- Name: student_profiles student_profiles_postal_code_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_profiles
    ADD CONSTRAINT student_profiles_postal_code_fkey FOREIGN KEY (postal_code) REFERENCES upchieve_old.postal_codes(code);


--
-- Name: student_profiles student_profiles_school_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_profiles
    ADD CONSTRAINT student_profiles_school_id_fkey FOREIGN KEY (school_id) REFERENCES upchieve_old.schools(id);


--
-- Name: student_profiles student_profiles_student_partner_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_profiles
    ADD CONSTRAINT student_profiles_student_partner_org_id_fkey FOREIGN KEY (student_partner_org_id) REFERENCES upchieve_old.student_partner_orgs(id);


--
-- Name: student_profiles student_profiles_student_partner_org_site_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_profiles
    ADD CONSTRAINT student_profiles_student_partner_org_site_id_fkey FOREIGN KEY (student_partner_org_site_id) REFERENCES upchieve_old.student_partner_org_sites(id);


--
-- Name: student_profiles student_profiles_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.student_profiles
    ADD CONSTRAINT student_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: subjects subjects_tool_type_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.subjects
    ADD CONSTRAINT subjects_tool_type_id_fkey FOREIGN KEY (tool_type_id) REFERENCES upchieve_old.tool_types(id);


--
-- Name: subjects subjects_topic_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.subjects
    ADD CONSTRAINT subjects_topic_id_fkey FOREIGN KEY (topic_id) REFERENCES upchieve_old.topics(id);


--
-- Name: user_actions user_actions_ip_address_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_actions
    ADD CONSTRAINT user_actions_ip_address_id_fkey FOREIGN KEY (ip_address_id) REFERENCES upchieve_old.ip_addresses(id);


--
-- Name: user_actions user_actions_session_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_actions
    ADD CONSTRAINT user_actions_session_id_fkey FOREIGN KEY (session_id) REFERENCES upchieve_old.sessions(id);


--
-- Name: user_actions user_actions_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_actions
    ADD CONSTRAINT user_actions_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: user_product_flags user_product_flags_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_product_flags
    ADD CONSTRAINT user_product_flags_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: user_session_metrics user_session_metrics_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.user_session_metrics
    ADD CONSTRAINT user_session_metrics_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: users users_ban_reason_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users
    ADD CONSTRAINT users_ban_reason_id_fkey FOREIGN KEY (ban_reason_id) REFERENCES upchieve_old.ban_reasons(id);


--
-- Name: users_certifications users_certifications_certification_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_certifications
    ADD CONSTRAINT users_certifications_certification_id_fkey FOREIGN KEY (certification_id) REFERENCES upchieve_old.certifications(id);


--
-- Name: users_certifications users_certifications_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_certifications
    ADD CONSTRAINT users_certifications_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: users_ip_addresses users_ip_addresses_ip_address_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_ip_addresses
    ADD CONSTRAINT users_ip_addresses_ip_address_id_fkey FOREIGN KEY (ip_address_id) REFERENCES upchieve_old.ip_addresses(id);


--
-- Name: users_ip_addresses users_ip_addresses_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_ip_addresses
    ADD CONSTRAINT users_ip_addresses_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: users_quizzes users_quizzes_quiz_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_quizzes
    ADD CONSTRAINT users_quizzes_quiz_id_fkey FOREIGN KEY (quiz_id) REFERENCES upchieve_old.quizzes(id);


--
-- Name: users_quizzes users_quizzes_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_quizzes
    ADD CONSTRAINT users_quizzes_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: users_roles users_roles_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_roles
    ADD CONSTRAINT users_roles_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: users users_signup_source_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users
    ADD CONSTRAINT users_signup_source_id_fkey FOREIGN KEY (signup_source_id) REFERENCES upchieve_old.signup_sources(id);


--
-- Name: users_training_courses users_training_courses_training_course_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_training_courses
    ADD CONSTRAINT users_training_courses_training_course_id_fkey FOREIGN KEY (training_course_id) REFERENCES upchieve_old.training_courses(id);


--
-- Name: users_training_courses users_training_courses_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.users_training_courses
    ADD CONSTRAINT users_training_courses_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: volunteer_occupations volunteer_occupations_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_occupations
    ADD CONSTRAINT volunteer_occupations_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: volunteer_profiles volunteer_profiles_photo_id_status_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_profiles
    ADD CONSTRAINT volunteer_profiles_photo_id_status_fkey FOREIGN KEY (photo_id_status) REFERENCES upchieve_old.photo_id_statuses(id);


--
-- Name: volunteer_profiles volunteer_profiles_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_profiles
    ADD CONSTRAINT volunteer_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);


--
-- Name: volunteer_profiles volunteer_profiles_volunteer_partner_org_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_profiles
    ADD CONSTRAINT volunteer_profiles_volunteer_partner_org_id_fkey FOREIGN KEY (volunteer_partner_org_id) REFERENCES upchieve_old.volunteer_partner_orgs(id);


--
-- Name: volunteer_references volunteer_references_status_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_references
    ADD CONSTRAINT volunteer_references_status_id_fkey FOREIGN KEY (status_id) REFERENCES upchieve_old.volunteer_reference_statuses(id);


--
-- Name: volunteer_references volunteer_references_user_id_fkey; Type: FK CONSTRAINT; Schema: upchieve_old; Owner: -
--

ALTER TABLE ONLY upchieve_old.volunteer_references
    ADD CONSTRAINT volunteer_references_user_id_fkey FOREIGN KEY (user_id) REFERENCES upchieve_old.users(id);
