\restrict VvyWzHe0IRRsoFBKYXsWALV9MYxSBsFmbRmDriEAgqphfCho0HhgHwZDkf9meM5
...
--
-- Name: freeze_initial_grade_level_id(); Type: FUNCTION; Schema: upchieve; Owner: -
--

CREATE FUNCTION upchieve.freeze_initial_grade_level_id() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF NEW.initial_grade_level_id IS DISTINCT FROM OLD.initial_grade_level_id THEN
        RAISE EXCEPTION 'initial_grade_level_id cannot be changed after it is set';
    END IF;
    RETURN NEW;
END;
$$;
...
CREATE TABLE upchieve.users_grade_levels (
    user_id uuid NOT NULL,
    initial_grade_level_id integer NOT NULL,
...
--
-- Name: users_grade_levels trg_freeze_initial_grade_level_id; Type: TRIGGER; Schema: upchieve; Owner: -
--

CREATE TRIGGER trg_freeze_initial_grade_level_id BEFORE UPDATE OF initial_grade_level_id ON upchieve.users_grade_levels FOR EACH ROW EXECUTE FUNCTION upchieve.freeze_initial_grade_level_id();
...
--
-- Name: users_grade_levels users_grade_levels_initial_grade_level_id_fkey; Type: FK CONSTRAINT; Schema: upchieve; Owner: -
--

ALTER TABLE ONLY upchieve.users_grade_levels
    ADD CONSTRAINT users_grade_levels_initial_grade_level_id_fkey FOREIGN KEY (initial_grade_level_id) REFERENCES upchieve.grade_levels(id);
...
\unrestrict VvyWzHe0IRRsoFBKYXsWALV9MYxSBsFmbRmDriEAgqphfCho0HhgHwZDkf9meM5
