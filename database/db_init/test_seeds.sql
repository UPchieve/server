...
\restrict 5rkvVgs6cp60tl1z60NEbfnAjCdJWtL7iVYe7cWb46pbKRwrCgdsWTGmvgROBSf
...
--
-- Data for Name: email_domain_blocklist; Type: TABLE DATA; Schema: upchieve; Owner: admin
--

COPY upchieve.email_domain_blocklist (id, domain, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: email_domain_blocklist_id_seq; Type: SEQUENCE SET; Schema: upchieve; Owner: admin
--

SELECT pg_catalog.setval('upchieve.email_domain_blocklist_id_seq', 1, false);
...
SELECT pg_catalog.setval('upchieve.nths_chapter_statuses_id_seq', 1, false);
...
SELECT pg_catalog.setval('upchieve.nths_school_affiliation_statuses_id_seq', 1, false);
...
\unrestrict 5rkvVgs6cp60tl1z60NEbfnAjCdJWtL7iVYe7cWb46pbKRwrCgdsWTGmvgROBSf
